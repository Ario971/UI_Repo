---
id: "lxiayu/dshcockpit"
name: "Lxiayu/DshCockpit"
url: "https://github.com/Lxiayu/DshCockpit"
date: "2026-08-20"
...
composite: 72
replacement_target: ""
related_articles: [{"title":"pingfanfan/dsh-learn","date":"2026-08-14","topic":"AI dev tools","similarity":0.294,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-08-14/11-pingfanfan-dsh-learn.md"},{"title":"Show HN: Parley – your coding agent can talk to a teammate's agent","date":"2026-08-11","topic":"AI agents","similarity":0.203,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-11/06-show-hn-parley-your-coding-agent-can-talk-to-a-teammate-s-agent.md"},{"title":"Show HN: HarnessRouter: Unified interface for agent harnesses","date":"2026-08-17","topic":"AI agents","similarity":0.192,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-17/06-show-hn-harnessrouter-unified-interface-for-agent-harnesses.md"}]
pros: ["Recently updated (2026-08-20)","MIT license","15 GitHub stars","GitHub Actions/CI detected"]
cons: ["README mentions credentials or API tokens","README mentions telemetry/analytics"]
readme_quality: 85
has_ci: true
has_tests: true
setup_steps_count: 2
dependency_files: [{"name":"package.json","summary":"deps @npmcli/arborist, @wecom/aibot-node-sdk, electron-updater, fzstd, node-forge, pacote, semver, electron; scripts start, build, build:win, build:win:dir, build:win:nsis, build:mac, publish:win, publish:mac"}]
install_commands: ["git clone https://github.com/Lxiayu/DshCockpit.git","npm install","npm start","npm test"]
...
## Why it matters
You saved an article on 2026-08-14 about AI dev tools; this candidate overlaps with "pingfanfan/dsh-learn" and may turn that reading into a practical workflow improvement.
...
Dependency files:
- package.json: deps @npmcli/arborist, @wecom/aibot-node-sdk, electron-updater, fzstd, node-forge, pacote, semver, electron; scripts start, build, build:win, build:win:dir, build:win:nsis, build:mac, publish:win, publish:mac
