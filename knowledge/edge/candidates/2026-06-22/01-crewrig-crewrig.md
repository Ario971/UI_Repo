...
composite: 73
replacement_target: ""
related_articles: [{"title":"jhwreal/wechat-article-pipeline-skill","date":"2026-05-28","topic":"AI agents","similarity":0.25,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-05-28/13-jhwreal-wechat-article-pipeline-skill.md"},{"title":"Show HN: Skill for your agent to visualize your gbrain and Obsidian","date":"2026-06-13","topic":"AI dev tools","similarity":0.237,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-06-13/11-show-hn-skill-for-your-agent-to-visualize-your-gbrain-and-obsidian.md"},{"title":"AlexNthLab/nth-dao","date":"2026-06-12","topic":"AI dev tools","similarity":0.189,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-06-12/97-alexnthlab-nth-dao.md"}]
pros: ["Recently updated (2026-06-22)","Apache-2.0 license","17 GitHub stars","GitHub Actions/CI detected"]
cons: ["README includes remote script execution pattern","May require elevated privileges"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 3
dependency_files: [{"name":"package.json","summary":"deps @semantic-release/changelog, @semantic-release/exec, @semantic-release/git, @semantic-release/github, js-yaml, markdownlint-cli, semantic-release, semantic-release-gitmoji; scripts build, test"}]
install_commands: ["git clone git@github.com:crewrig/crewrig.git","claude /init-personal-profile","claude /init-soul","CLAUDE.md                             # Claude Code entry point (@AGENTS.md)","claude mcp list                      # Show registered servers","claude mcp add --scope user <name> -- <command> [args...]"]
risk_flags: ["README includes remote script execution pattern","May require elevated privileges"]
status: "new"
---
...
Dependency files:
- package.json: deps @semantic-release/changelog, @semantic-release/exec, @semantic-release/git, @semantic-release/github, js-yaml, markdownlint-cli, semantic-release, semantic-release-gitmoji; scripts build, test
