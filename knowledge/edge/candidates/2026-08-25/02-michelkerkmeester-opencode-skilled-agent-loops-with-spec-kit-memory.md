---
id: "michelkerkmeester/opencode--skilled-agent-loops-with-spec-kit-memory"
name: "MichelKerkmeester/opencode--skilled-agent-loops-with-spec-kit-memory"
url: "https://github.com/MichelKerkmeester/opencode--skilled-agent-loops-with-spec-kit-memory"
date: "2026-08-25"
...
composite: 70
replacement_target: ""
related_articles: [{"title":"LamsonRetail/lsr-agent-platform","date":"2026-08-18","topic":"AI dev tools","similarity":0.292,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-08-18/13-lamsonretail-lsr-agent-platform.md"},{"title":"Show HN: Keen Code – an agentic-engineered coding agent","date":"2026-08-10","topic":"AI agents","similarity":0.286,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-10/06-show-hn-keen-code-an-agentic-engineered-coding-agent.md"},{"title":"Show HN: Agent Memory Leaderboard – first public results for AI memory systems","date":"2026-08-13","topic":"AI agents","similarity":0.267,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-13/09-show-hn-agent-memory-leaderboard-first-public-results-for-ai-memory-sy.md"}]
pros: ["Recently updated (2026-08-25)","MIT license","32 GitHub stars","GitHub Actions/CI detected"]
cons: ["README mentions credentials or API tokens","README mentions telemetry/analytics"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 4
dependency_files: [{"name":"package.json","summary":"deps chokidar, cors, express, @types/node; scripts dev"}]
install_commands: ["git clone https://github.com/MichelKerkmeester/opencode--spec-kit-skilled-agent-orchestration.git","npm install","ollama pull nomic-embed-text:v1.5","codex exec","npm run stress"]
...
Dependency files:
- package.json: deps chokidar, cors, express, @types/node; scripts dev
