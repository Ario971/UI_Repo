...
composite: 71
replacement_target: ""
related_articles: [{"title":"Show HN: Keen Code – an agentic-engineered coding agent","date":"2026-08-10","topic":"AI agents","similarity":0.47,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-10/06-show-hn-keen-code-an-agentic-engineered-coding-agent.md"},{"title":"LamsonRetail/lsr-agent-platform","date":"2026-08-18","topic":"AI dev tools","similarity":0.446,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-08-18/13-lamsonretail-lsr-agent-platform.md"},{"title":"Show HN: Parley – your coding agent can talk to a teammate's agent","date":"2026-08-11","topic":"AI agents","similarity":0.429,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-11/06-show-hn-parley-your-coding-agent-can-talk-to-a-teammate-s-agent.md"}]
pros: ["Recently updated (2026-09-13)","MIT license","3 GitHub stars","GitHub Actions/CI detected"]
...
has_tests: true
setup_steps_count: 5
dependency_files: [{"name":"pyproject.toml","summary":"python project; deps name, version, description, readme, requires-python, dependencies, litellm, openai-codex"},{"name":"requirements.txt","summary":"deps litellm>=1.60.0, tenacity>=8.0, pydantic>=2.0, python-dotenv>=1.0, jinja2>=3.1, rich>=13.7.0, textual>=1.0.0, prompt_toolkit>=3.0.47"}]
install_commands: ["uv tool install --python 3.12 --force \"git+https://github.com/KhanUzeb/kite.git\"","uv tool update-shell","git clone https://github.com/KhanUzeb/kite.git && cd kite","uv tool install \"git+https://github.com/KhanUzeb/kite.git\"","uv tool upgrade kite","uv tool uninstall kite"]
...
Slim hybrid coding-agent harness: mini-swe-agent loop + tau-style tools, providers, skills, and guardrails. Multi-provider, MCP-native, Rich TUI.
...
Dependency files:
- pyproject.toml: python project; deps name, version, description, readme, requires-python, dependencies, litellm, openai-codex
- requirements.txt: deps litellm>=1.60.0, tenacity>=8.0, pydantic>=2.0, python-dotenv>=1.0, jinja2>=3.1, rich>=13.7.0, textual>=1.0.0, prompt_toolkit>=3.0.47
