...
composite: 81
replacement_target: ""
related_articles: [{"title":"Show HN: Cost.dev (YC W21) – making agents cost-aware and cheaper to call","date":"2026-06-04","topic":"AI agents","similarity":0.269,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-06-04/09-show-hn-cost-dev-yc-w21-making-agents-cost-aware-and-cheaper-to-call.md"},{"title":"Show HN: I Made a Claude Skill for Spec-Driven Development (SDD)","date":"2026-05-21","topic":"AI dev tools","similarity":0.232,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-05-21/43-show-hn-i-made-a-claude-skill-for-spec-driven-development-sdd.md"},{"title":"Which Coding Agent Features Are Useful For Local LLMs","date":"2026-05-29","topic":"Local LLMs","similarity":0.227,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/Local LLMs/2026-05-29/31-which-coding-agent-features-are-useful-for-local-llms.md"}]
pros: ["Recently updated (2026-06-19)","MIT license","22498 GitHub stars","GitHub Actions/CI detected"]
cons: ["README includes remote script execution pattern"]
readme_quality: 85
has_ci: true
has_tests: true
setup_steps_count: 2
dependency_files: [{"name":"package.json","summary":"deps @kilocode/plugin, @opencode-ai/script, @kilocode/sdk, typescript, @tsconfig/bun, @types/mime-types, @typescript/native-preview, glob; scripts dev, dev:storybook, lint, typecheck, upgrade-opentui, postinstall, prepare, random"}]
install_commands: ["npm install -g @kilocode/cli","pnpm add -g @kilocode/cli"]
...
Dependency files:
- package.json: deps @kilocode/plugin, @opencode-ai/script, @kilocode/sdk, typescript, @tsconfig/bun, @types/mime-types, @typescript/native-preview, glob; scripts dev, dev:storybook, lint, typecheck, upgrade-opentui, postinstall, prepare, random
