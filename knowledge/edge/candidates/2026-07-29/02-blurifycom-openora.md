---
id: "blurifycom/openora"
name: "blurifycom/openora"
url: "https://github.com/blurifycom/openora"
date: "2026-07-29"
...
composite: 71
replacement_target: ""
related_articles: [{"title":"blurifycom/openora","date":"2026-07-29","topic":"AI dev tools","similarity":0.782,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-07-29/12-blurifycom-openora.md"},{"title":"Adoption and Ecosystem Health: A Longitudinal Analysis of Open-Source Multi-Agent Frameworks","date":"2026-07-02","topic":"AI agents","similarity":0.184,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-07-02/08-adoption-and-ecosystem-health-a-longitudinal-analysis-of-open-source-m.md"}]
pros: ["Recently updated (2026-07-29)","AGPL-3.0 license","18 GitHub stars","GitHub Actions/CI detected"]
cons: ["No obvious v1 warning, still review upstream code before use"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 3
dependency_files: [{"name":"package.json","summary":"deps @changesets/cli, @commitlint/cli, @commitlint/config-conventional, @openora/core, @openora/testing, @orpc/contract, @turbo/gen, @types/node; scripts build, dev, clean, verify, check:types, check:lint, check:format, check:boundaries"}]
install_commands: ["pnpm setup   # checks prereqs, installs deps, boots Postgres, runs migrations, prints a summary","pnpm db:seed          # demo data: admin + players + wallets + transactions + games","pnpm dev           # api :3001","claude mcp list    # verify the oss-dev server is connected","pnpm install                                  # install workspace deps","docker compose up -d                          # start Postgres + Redis (library-first: no app containers)"]
risk_flags: []
status: "new"
---
...
## Why it matters
You saved an article on 2026-07-29 about AI dev tools; this candidate overlaps with "blurifycom/openora" and may turn that reading into a practical workflow improvement.
...
Dependency files:
- package.json: deps @changesets/cli, @commitlint/cli, @commitlint/config-conventional, @openora/core, @openora/testing, @orpc/contract, @turbo/gen, @types/node; scripts build, dev, clean, verify, check:types, check:lint, check:format, check:boundaries
