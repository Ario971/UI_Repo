---
id: "nicholasgriffintn/ai-platform"
name: "nicholasgriffintn/ai-platform"
url: "https://github.com/nicholasgriffintn/ai-platform"
date: "2026-07-29"
...
composite: 70
replacement_target: ""
related_articles: [{"title":"Show HN: Vehir – a platform built for AI agents: compiler, microkernel, CAS","date":"2026-07-15","topic":"AI agents","similarity":0.235,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-07-15/06-show-hn-vehir-a-platform-built-for-ai-agents-compiler-microkernel-cas.md"},{"title":"Show HN: Vektorgeist- A platform for AI operators and their agent's","date":"2026-07-16","topic":"AI agents","similarity":0.211,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-07-16/08-show-hn-vektorgeist-a-platform-for-ai-operators-and-their-agent-s.md"},{"title":"SaswataGA/FairRent-AI-assisted-rental-platform","date":"2026-07-26","topic":"AI dev tools","similarity":0.18,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-07-26/12-saswataga-fairrent-ai-assisted-rental-platform.md"}]
pros: ["Recently updated (2026-07-29)","Apache-2.0 license","28 GitHub stars","GitHub Actions/CI detected"]
...
has_tests: true
setup_steps_count: 5
dependency_files: [{"name":"package.json","summary":"deps @playwright/test, @types/node, @vitest/browser-playwright, @vitest/coverage-v8, sherif, vitest; scripts format, lint, lint:monorepo, check, typecheck, test, coverage, ci:test"}]
install_commands: ["pnpm install","pnpm run dev","pnpm run dev:app","pnpm run dev:api","pnpm run dev:metrics","pnpm run deploy"]
...
## Why it matters
You saved an article on 2026-07-15 about AI agents; this candidate overlaps with "Show HN: Vehir – a platform built for AI agents: compiler, microkernel, CAS" and may turn that reading into a practical workflow improvement.
...
Dependency files:
- package.json: deps @playwright/test, @types/node, @vitest/browser-playwright, @vitest/coverage-v8, sherif, vitest; scripts format, lint, lint:monorepo, check, typecheck, test, coverage, ci:test
