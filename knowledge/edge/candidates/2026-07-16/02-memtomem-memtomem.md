...
composite: 78
replacement_target: ""
related_articles: [{"title":"Agent-Native Immune System: Architecture, Taxonomy, and Engineering","date":"2026-06-26","topic":"AI agents","similarity":0.288,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-06-26/06-agent-native-immune-system-architecture-taxonomy-and-engineering.md"},{"title":"Show HN: Kage, verification and freshness for Google's OKF agent memory","date":"2026-06-30","topic":"AI agents","similarity":0.267,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-06-30/07-show-hn-kage-verification-and-freshness-for-google-s-okf-agent-memory.md"},{"title":"llm011/ethan-agent","date":"2026-06-20","topic":"AI dev tools","similarity":0.262,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-06-20/93-llm011-ethan-agent.md"}]
pros: ["Recently updated (2026-07-16)","Apache-2.0 license","11 GitHub stars","GitHub Actions/CI detected"]
cons: ["Integration may take more than a quick install"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 3
dependency_files: [{"name":"pyproject.toml","summary":"python project; deps name, version, description, requires-python, dependencies, members, memtomem, target-version"}]
install_commands: ["uv tool install 'memtomem[all]'       # or: pipx install 'memtomem[all]'","uv tool install memtomem             # no extras — dense search, web UI, Korean tokenizer unavailable until you add them","uv add 'memtomem[all]' && uv run mm init    # all commands need `uv run` prefix","claude mcp add memtomem -s user -- uvx --isolated --from \"memtomem[all]==0.3.11\" memtomem-server","uv tool install 'memtomem[all]' --refresh","uv cache clean memtomem"]
risk_flags: []
status: "new"
---
...
Dependency files:
- pyproject.toml: python project; deps name, version, description, requires-python, dependencies, members, memtomem, target-version
