---
id: "shabaraba/vibing.nvim"
name: "shabaraba/vibing.nvim"
url: "https://github.com/shabaraba/vibing.nvim"
date: "2026-08-15"
...
composite: 75
replacement_target: ""
related_articles: [{"title":"Show HN: Claude-account – switch Claude Code accounts without logging in again","date":"2026-07-30","topic":"AI dev tools","similarity":0.334,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-07-30/12-show-hn-claude-account-switch-claude-code-accounts-without-logging-in-.md"},{"title":"Bennyoooo/write-like-me","date":"2026-08-06","topic":"AI agents","similarity":0.258,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-06/06-bennyoooo-write-like-me.md"},{"title":"Show HN: Keen Code – an agentic-engineered coding agent","date":"2026-08-10","topic":"AI agents","similarity":0.199,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-10/06-show-hn-keen-code-an-agentic-engineered-coding-agent.md"}]
pros: ["Recently updated (2026-08-15)","MIT license","14 GitHub stars","GitHub Actions/CI detected"]
cons: ["README mentions telemetry/analytics"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 3
dependency_files: [{"name":"package.json","summary":"deps neovim, zod, @eslint/js, @types/node, esbuild, eslint, markdownlint-cli, prettier; scripts build, build:watch, test, test:node, test:lua, test:e2e, test:eval, check"}]
install_commands: ["Claude[\"Claude CLI<br/>(claude -p --output-format stream-json)\"]","Codex[\"Codex CLI<br/>(codex exec --json)\"]","claude -p --output-format stream-json","codex exec --json","npm install -g @anthropic-ai/claude-code","npm install -g @openai/codex"]
...
Dependency files:
- package.json: deps neovim, zod, @eslint/js, @types/node, esbuild, eslint, markdownlint-cli, prettier; scripts build, build:watch, test, test:node, test:lua, test:e2e, test:eval, check
