---
id: "saarshai/brainer"
name: "SaarShai/Brainer"
url: "https://github.com/SaarShai/Brainer"
date: "2026-06-27"
...
momentum: 45
risk: 32
integration_effort: 54
expected_gain: 87
composite: 72
replacement_target: ""
related_articles: [{"title":"Show HN: Skill for your agent to visualize your gbrain and Obsidian","date":"2026-06-13","topic":"AI dev tools","similarity":0.262,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-06-13/11-show-hn-skill-for-your-agent-to-visualize-your-gbrain-and-obsidian.md"},{"title":"jhwreal/wechat-article-pipeline-skill","date":"2026-05-28","topic":"AI agents","similarity":0.226,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-05-28/13-jhwreal-wechat-article-pipeline-skill.md"},{"title":"llm011/ethan-agent","date":"2026-06-20","topic":"AI dev tools","similarity":0.213,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-06-20/93-llm011-ethan-agent.md"}]
pros: ["Recently updated (2026-06-27)","MIT license","GitHub Actions/CI detected","README mentions tests or validation"]
cons: ["README mentions credentials or API tokens"]
readme_quality: 85
has_ci: true
has_tests: true
setup_steps_count: 4
dependency_files: [{"name":"pyproject.toml","summary":"python project; deps name, version, description, requires-python, dependencies, dev, pytest, testpaths"}]
install_commands: ["git clone https://github.com/SaarShai/Brainer.git .brainer","git clone https://github.com/SaarShai/Brainer.git ~/.local/share/brainer && claude plugin install ~/.local/share/brainer/.claude-plugin/marketplace.json","git worktree remove"]
...
Brainer — lean, verified agent-skill catalog (token-use · context-window · wiki-memory · self-improvement). Formerly token-economy.
...
Dependency files:
- pyproject.toml: python project; deps name, version, description, requires-python, dependencies, dev, pytest, testpaths

Install commands found:
- git clone https://github.com/SaarShai/Brainer.git .brainer
- git clone https://github.com/SaarShai/Brainer.git ~/.local/share/brainer && claude plugin install ~/.local/share/brainer/.claude-plugin/marketplace.json
- git worktree remove
