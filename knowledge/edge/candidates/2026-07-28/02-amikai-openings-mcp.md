---
id: "amikai/openings-mcp"
name: "amikai/openings-mcp"
...
composite: 73
replacement_target: ""
related_articles: [{"title":"Zenetusken/job-applicator-python","date":"2026-06-30","topic":"AI dev tools","similarity":0.329,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-06-30/13-zenetusken-job-applicator-python.md"},{"title":"yearningss/gamemaker-mcp","date":"2026-07-25","topic":"AI dev tools","similarity":0.302,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-07-25/13-yearningss-gamemaker-mcp.md"},{"title":"Show HN: Pull Claude Code transcripts into your Codex session, and vice versa","date":"2026-07-03","topic":"AI dev tools","similarity":0.22,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-07-03/11-show-hn-pull-claude-code-transcripts-into-your-codex-session-and-vice-.md"}]
pros: ["Recently updated (2026-07-28)","MIT license","73 GitHub stars","GitHub Actions/CI detected"]
cons: ["Integration may take more than a quick install","README mentions credentials or API tokens"]
readme_quality: 85
has_ci: true
has_tests: false
setup_steps_count: 4
dependency_files: [{"name":"go.mod","summary":"module github.com/amikai/openings-mcp"}]
install_commands: ["go install github.com/amikai/openings-mcp/cmd/openings-mcp@latest","docker pull ghcr.io/amikai/openings-mcp","claude mcp add openings-mcp -- openings-mcp","codex mcp add openings-mcp -- openings-mcp","claude mcp add openings-mcp -- docker run -i --rm ghcr.io/amikai/openings-mcp","docker run -i --rm ghcr.io/amikai/openings-mcp"]
...
## Why it matters
You saved an article on 2026-06-30 about AI dev tools; this candidate overlaps with "Zenetusken/job-applicator-python" and may turn that reading into a practical workflow improvement.

## Pros
+ Recently updated (2026-07-28)
+ MIT license
+ 73 GitHub stars
...
Dependency files:
- go.mod: module github.com/amikai/openings-mcp
...
- docker run -i --rm ghcr.io/amikai/openings-mcp
