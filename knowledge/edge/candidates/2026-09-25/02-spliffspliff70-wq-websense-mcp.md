---
id: "spliffspliff70-wq/websense-mcp"
name: "spliffspliff70-wq/websense-mcp"
url: "https://github.com/spliffspliff70-wq/websense-mcp"
date: "2026-09-25"
...
composite: 74
replacement_target: ""
related_articles: [{"title":"how to setup llama.cpp and blender to make lovely 3d stuff together","date":"2026-08-28","topic":"Local LLMs","similarity":0.267,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/Local LLMs/2026-08-28/16-how-to-setup-llama-cpp-and-blender-to-make-lovely-3d-stuff-together.md"},{"title":"Show HN: MCP Tool Definition Quality Score (TDQS) Spec","date":"2026-09-03","topic":"AI dev tools","similarity":0.242,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-09-03/10-show-hn-mcp-tool-definition-quality-score-tdqs-spec.md"},{"title":"Show HN: Hands-Rust MCP/CLI that sees the Windows desktop and clicks real Chrome","date":"2026-08-23","topic":"AI dev tools","similarity":0.209,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-08-23/11-show-hn-hands-rust-mcp-cli-that-sees-the-windows-desktop-and-clicks-re.md"}]
pros: ["Recently updated (2026-09-25)","MIT license","5 GitHub stars","GitHub Actions/CI detected"]
cons: ["No obvious v1 warning, still review upstream code before use"]
readme_quality: 85
has_ci: true
has_tests: true
setup_steps_count: 1
dependency_files: [{"name":"package.json","summary":"deps @modelcontextprotocol/sdk, ws, zod; scripts start, test"}]
install_commands: ["npm test","git clone https://github.com/spliffspliff70-wq/websense-mcp && cd websense-mcp && npm install"]
risk_flags: []
status: "new"
---

# spliffspliff70-wq/websense-mcp

WebSense MCP — non-vision, AI-native browser automation via the Semantic Action Graph. No screenshots, no CDP, no bot detection.
...
Dependency files:
- package.json: deps @modelcontextprotocol/sdk, ws, zod; scripts start, test

Install commands found:
- npm test
- git clone https://github.com/spliffspliff70-wq/websense-mcp && cd websense-mcp && npm install
