---
id: "bigbio/sdrf-skills"
name: "bigbio/sdrf-skills"
url: "https://github.com/bigbio/sdrf-skills"
date: "2026-07-09"
...
replacement_target: ""
related_articles: []
pros: ["Recently updated (2026-07-09)","MIT license","8 GitHub stars","GitHub Actions/CI detected"]
cons: ["No obvious v1 warning, still review upstream code before use"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 5
dependency_files: [{"name":"requirements.txt","summary":"deps sdrf-pipelines[ontology], requests>=2.28, defusedxml>=0.7"}]
install_commands: ["git clone --recurse-submodules https://github.com/bigbio/sdrf-skills","git submodule update --init --recursive","git submodule update --remote --recursive","pip install -r requirements.txt","Claude: For your experiment, I recommend:","Claude:"]
risk_flags: []
status: "new"
---
...
## Why it matters
bigbio/sdrf-skills matches your AI development source filters and scored strongly enough to review before it disappears into the daily noise.
...
Dependency files:
- requirements.txt: deps sdrf-pipelines[ontology], requests>=2.28, defusedxml>=0.7
