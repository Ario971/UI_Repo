...
composite: 86
replacement_target: ""
related_articles: [{"title":"Show HN: I Made a Claude Skill for Spec-Driven Development (SDD)","date":"2026-05-21","topic":"AI dev tools","similarity":0.312,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-05-21/43-show-hn-i-made-a-claude-skill-for-spec-driven-development-sdd.md"},{"title":"jhwreal/wechat-article-pipeline-skill","date":"2026-05-28","topic":"AI agents","similarity":0.289,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-05-28/13-jhwreal-wechat-article-pipeline-skill.md"},{"title":"Show HN: Agent-estimate, how long a coding task takes, at agent speed","date":"2026-05-21","topic":"AI agents","similarity":0.27,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-05-21/40-show-hn-agent-estimate-how-long-a-coding-task-takes-at-agent-speed.md"}]
pros: ["Recently updated (2026-06-01)","MIT license","2156 GitHub stars","GitHub Actions/CI detected"]
cons: ["README mentions credentials or API tokens"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 1
dependency_files: [{"name":"requirements.txt","summary":"deps markdown==3.10.2, beautifulsoup4==4.14.3, cssutils==2.11.1, requests==2.33.1, camoufox[geoip]==0.4.11, pyyaml==6.0.1, Pygments==2.17.2, Pillow==12.2.0"}]
install_commands: ["git clone --depth 1 https://github.com/oaker-io/wewrite.git ~/.claude/skills/wewrite","git clone --depth 1 https://github.com/oaker-io/wewrite.git ~/.openclaw/skills/wewrite"]
...
Dependency files:
- requirements.txt: deps markdown==3.10.2, beautifulsoup4==4.14.3, cssutils==2.11.1, requests==2.33.1, camoufox[geoip]==0.4.11, pyyaml==6.0.1, Pygments==2.17.2, Pillow==12.2.0
