...
composite: 66
replacement_target: ""
related_articles: [{"title":"qgeng1465/bio-mcp","date":"2026-08-11","topic":"AI dev tools","similarity":0.363,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-08-11/13-qgeng1465-bio-mcp.md"},{"title":"yearningss/gamemaker-mcp","date":"2026-07-25","topic":"AI dev tools","similarity":0.256,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-07-25/13-yearningss-gamemaker-mcp.md"},{"title":"Llama.cpp now has full MCP support!","date":"2026-07-25","topic":"Local LLMs","similarity":0.252,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/Local LLMs/2026-07-25/14-llama-cpp-now-has-full-mcp-support.md"}]
pros: ["Recently updated (2026-08-21)","MIT license","1 GitHub stars","GitHub Actions/CI detected"]
...
has_tests: true
setup_steps_count: 2
dependency_files: [{"name":"package.json","summary":"deps @deepseek-ai/cordis, @deepseek-ai/dsh-storage, @deepseek-ai/dsh-storage-domain, @deepseek-ai/schemastery, zod; scripts test, lint, registry:build, registry:validate, dev:ui, verify-pack, check, prepublishOnly"}]
install_commands: ["npm run check","npm run registry:build","npm run registry:validate","npm run dev:ui"]
...
DeepSeek Harness MCP Connector marketplace and connection manager
...
Dependency files:
- package.json: deps @deepseek-ai/cordis, @deepseek-ai/dsh-storage, @deepseek-ai/dsh-storage-domain, @deepseek-ai/schemastery, zod; scripts test, lint, registry:build, registry:validate, dev:ui, verify-pack, check, prepublishOnly
