---
id: "akashgit/remote-factory"
name: "akashgit/remote-factory"
...
composite: 74
replacement_target: ""
related_articles: [{"title":"greetingromansoldier/agora-perp-agent","date":"2026-06-13","topic":"AI agents","similarity":0.326,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-06-13/06-greetingromansoldier-agora-perp-agent.md"},{"title":"Show HN: Agent-estimate, how long a coding task takes, at agent speed","date":"2026-05-21","topic":"AI agents","similarity":0.321,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-05-21/40-show-hn-agent-estimate-how-long-a-coding-task-takes-at-agent-speed.md"},{"title":"Show HN: Cost.dev (YC W21) – making agents cost-aware and cheaper to call","date":"2026-06-04","topic":"AI agents","similarity":0.317,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-06-04/09-show-hn-cost-dev-yc-w21-making-agents-cost-aware-and-cheaper-to-call.md"}]
...
has_tests: true
setup_steps_count: 4
dependency_files: [{"name":"pyproject.toml","summary":"python project; deps name, version, description, requires-python, dependencies, pydantic, structlog, fastapi"}]
install_commands: ["git clone https://github.com/akashgit/remote-factory.git","uv sync","uv run factory","uv run factory ceo \"Build a personal homepage with a blog\" --mode design","uv run factory ceo \"distributed task runner\" --mode design","uv run factory ceo ~/ideas/my-app-spec.md --mode design"]
...
Dependency files:
- pyproject.toml: python project; deps name, version, description, requires-python, dependencies, pydantic, structlog, fastapi
