...
composite: 74
replacement_target: ""
related_articles: [{"title":"Show HN: Dev tools in one static site, no framework, no server","date":"2026-08-24","topic":"AI dev tools","similarity":0.198,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-08-24/13-show-hn-dev-tools-in-one-static-site-no-framework-no-server.md"}]
pros: ["Recently updated (2026-09-22)","Apache-2.0 license","162 GitHub stars","GitHub Actions/CI detected"]
cons: ["Integration may take more than a quick install","README mentions telemetry/analytics"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 4
dependency_files: [{"name":"pyproject.toml","summary":"python project; deps requires, build-backend, name, dynamic, description, readme, requires-python, dependencies"}]
install_commands: ["pip install agentevals-cli","pip install \"agentevals-cli[live]\"        # MCP server support","pip install \"agentevals-cli[openai]\"      # OpenAI Evals API graders","uv sync","docker build -t agentevals .","docker run -p 8001:8001 -p 4317:4317 -p 4318:4318 agentevals"]
...
Dependency files:
- pyproject.toml: python project; deps requires, build-backend, name, dynamic, description, readme, requires-python, dependencies
