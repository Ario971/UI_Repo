...
composite: 80
replacement_target: ""
related_articles: [{"title":"gHashTag/trios-mcp-rag","date":"2026-05-23","topic":"AI agents","similarity":0.324,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-05-23/53-ghashtag-trios-mcp-rag.md"},{"title":"rutulraval/ai-coding-agents-autogen","date":"2026-06-01","topic":"AI agents","similarity":0.221,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-06-01/59-rutulraval-ai-coding-agents-autogen.md"},{"title":"Show HN: Using Tailscale with an OrbStack VM on macOS","date":"2026-05-25","topic":"AI agents","similarity":0.217,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-05-25/89-show-hn-using-tailscale-with-an-orbstack-vm-on-macos.md"}]
pros: ["Recently updated (2026-06-13)","MIT license","4697 GitHub stars","GitHub Actions/CI detected"]
cons: ["Integration may take more than a quick install","README mentions credentials or API tokens"]
readme_quality: 85
has_ci: true
has_tests: true
setup_steps_count: 4
dependency_files: [{"name":"package.json","summary":"deps chrome-devtools-mcp; scripts build:cli, build:cli:release, build:swift, build:swift:all, build:polter, app:restart, build, test:safe"}]
install_commands: ["npx -y @steipete/peekaboo","pnpm install","pnpm run build:cli","pnpm run test:safe","pnpm run lint && pnpm run format"]
...
Dependency files:
- package.json: deps chrome-devtools-mcp; scripts build:cli, build:cli:release, build:swift, build:swift:all, build:polter, app:restart, build, test:safe
