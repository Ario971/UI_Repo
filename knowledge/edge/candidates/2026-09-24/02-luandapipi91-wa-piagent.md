---
id: "luandapipi91/wa-piagent"
name: "luandapipi91/Wa-PiAgent"
url: "https://github.com/luandapipi91/Wa-PiAgent"
date: "2026-09-24"
...
composite: 71
replacement_target: ""
related_articles: [{"title":"Show HN: Agent Chaperone – Screen AI agent tool calls and results with Jev","date":"2026-09-21","topic":"AI dev tools","similarity":0.479,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-09-21/10-show-hn-agent-chaperone-screen-ai-agent-tool-calls-and-results-with-je.md"},{"title":"pradverma94/ai-support-agent","date":"2026-09-13","topic":"AI dev tools","similarity":0.447,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-09-13/12-pradverma94-ai-support-agent.md"},{"title":"Prime Agent: A Self-Improving RLM Harness","date":"2026-08-24","topic":"AI agents","similarity":0.364,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-24/08-prime-agent-a-self-improving-rlm-harness.md"}]
pros: ["Recently updated (2026-09-24)","MIT license","2 GitHub stars","README mentions tests or validation"]
cons: ["README mentions credentials or API tokens"]
readme_quality: 100
has_ci: false
has_tests: true
setup_steps_count: 1
dependency_files: [{"name":"package.json","summary":"deps @aws-sdk/client-s3, @happy-dom/global-registrator, @types/bun, @wa-pi/shared, happy-dom, typescript; scripts dev, dev:kernel, dev:frontend, dev:desktop, test, typecheck, pack:win, pack:linux"}]
install_commands: ["git clone https://github.com/luandapipi91/Wa-PiAgent.git"]
risk_flags: ["README mentions credentials or API tokens"]
status: "new"
---

# luandapipi91/Wa-PiAgent

A desktop GUI client for the pi agent (pi coding agent). Run an AI agent team — MCP, skills, memory, IM channels. macOS / Windows / Linux, Electron + React.
...
Dependency files:
- package.json: deps @aws-sdk/client-s3, @happy-dom/global-registrator, @types/bun, @wa-pi/shared, happy-dom, typescript; scripts dev, dev:kernel, dev:frontend, dev:desktop, test, typecheck, pack:win, pack:linux
