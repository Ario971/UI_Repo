...
id: "hierrr/madison"
name: "hierrr/madison"
url: "https://github.com/hierrr/madison"
date: "2026-09-10"
...
composite: 68
replacement_target: ""
related_articles: [{"title":"hierrr/madison","date":"2026-09-10","topic":"AI dev tools","similarity":0.862,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-09-10/10-hierrr-madison.md"},{"title":"Show HN: Self-hosted company OS, Claude Code and Codex agents in departments","date":"2026-09-09","topic":"AI agents","similarity":0.272,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-09-09/06-show-hn-self-hosted-company-os-claude-code-and-codex-agents-in-departm.md"},{"title":"Show HN: Proliferate- open-source, self-hostable Codex for any coding agent","date":"2026-08-21","topic":"AI agents","similarity":0.27,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-21/07-show-hn-proliferate-open-source-self-hostable-codex-for-any-coding-age.md"}]
pros: ["Recently updated (2026-09-10)","MIT license","README mentions tests or validation","README includes install commands"]
...
has_tests: true
setup_steps_count: 4
dependency_files: [{"name":"requirements.txt","summary":"deps fastapi>=0.110, uvicorn>=0.29, PyJWT>=2.8, cryptography>=42"}]
install_commands: ["git clone https://github.com/hierrr/madison.git","claude --resume <id>","codex resume <id>","CLAUDE CODE","CLAUDE APP","CODEX CLI"]
...
Supervise Claude Code & Codex sessions across all your machines — self-hosted hub: live fleet status, cross-device handoffs, daily work reports, token & rate-limit history
...
Dependency files:
- requirements.txt: deps fastapi>=0.110, uvicorn>=0.29, PyJWT>=2.8, cryptography>=42
