---
id: "chicago-desktop/tui-desktop"
name: "chicago-desktop/tui-desktop"
url: "https://github.com/chicago-desktop/tui-desktop"
date: "2026-09-16"
...
replacement_target: ""
related_articles: []
pros: ["Recently updated (2026-09-16)","MIT license","GitHub Actions/CI detected","README mentions tests or validation"]
...
# chicago-desktop/tui-desktop

The window manager for the terminal on the Wippy runtime: a compositor of overlapping windows, real programs under a PTY, one desktop per SSH connection, and a command channel an agent can drive.

URL: https://github.com/chicago-desktop/tui-desktop

## Why it matters
chicago-desktop/tui-desktop matches your AI development source filters and scored strongly enough to review before it disappears into the daily noise.
