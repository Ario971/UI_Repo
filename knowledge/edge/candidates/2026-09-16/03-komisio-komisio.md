---
id: "komisio/komisio"
name: "Komisio/komisio"
url: "https://github.com/Komisio/komisio"
date: "2026-09-16"
...
composite: 68
replacement_target: ""
related_articles: [{"title":"Show HN: Itsuki – open-source memory engine for AI agents (API and MCP)","date":"2026-08-29","topic":"AI agents","similarity":0.31,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-29/06-show-hn-itsuki-open-source-memory-engine-for-ai-agents-api-and-mcp.md"},{"title":"Show HN: An open-source control plane for your company's AI agents","date":"2026-09-14","topic":"AI agents","similarity":0.3,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-09-14/06-show-hn-an-open-source-control-plane-for-your-company-s-ai-agents.md"},{"title":"Show HN: Open tool for testing your AI Agents (No LLM)","date":"2026-08-28","topic":"AI agents","similarity":0.272,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-28/06-show-hn-open-tool-for-testing-your-ai-agents-no-llm.md"}]
pros: ["Recently updated (2026-09-16)","AGPL-3.0 license","1 GitHub stars","GitHub Actions/CI detected"]
cons: ["Integration may take more than a quick install"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 3
dependency_files: [{"name":"package.json","summary":"deps @modelcontextprotocol/server, @radix-ui/react-slot, @supabase/ssr, @supabase/supabase-js, class-variance-authority, clsx, lucide-react, next; scripts dev, build, start, lint, format, format:check, typecheck, test"}]
install_commands: ["git clone https://github.com/Komisio/komisio.git","npm ci","npm run db:start","npm run db:migrate","npm run dev","npm run lint"]
risk_flags: []
status: "new"
---
...
Second-hand deserves first-class software. Open-source consignment software for second-hand stores. Sweden first. Platform preview.

URL: https://github.com/Komisio/komisio

## Why it matters
You saved an article on 2026-08-29 about AI agents; this candidate overlaps with "Show HN: Itsuki – open-source memory engine for AI agents (API and MCP)" and may turn that reading into a practical workflow improvement.
...
Dependency files:
- package.json: deps @modelcontextprotocol/server, @radix-ui/react-slot, @supabase/ssr, @supabase/supabase-js, class-variance-authority, clsx, lucide-react, next; scripts dev, build, start, lint, format, format:check, typecheck, test
...
| Chains with numbers in total and item moves; stock report per category        | Shopify products out and orders in, item import, partner API                           |
