---
id: "emtemf/enterprise-harness"
name: "Emtemf/enterprise-harness"
url: "https://github.com/Emtemf/enterprise-harness"
date: "2026-07-24"
...
composite: 72
replacement_target: ""
related_articles: [{"title":"Kuberwastaken/VPSmaxxing","date":"2026-06-30","topic":"AI dev tools","similarity":0.309,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-06-30/13-kuberwastaken-vpsmaxxing.md"},{"title":"Show HN: Abralo – Free, easy way to run several Claude Code agents in one window","date":"2026-07-08","topic":"AI agents","similarity":0.266,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-07-08/07-show-hn-abralo-free-easy-way-to-run-several-claude-code-agents-in-one-.md"},{"title":"UPDATE: I built a tool to turn your Claude Code sessions into fine-tuning data for local models (You can now convert your Codex and Pi sessions)","date":"2026-07-07","topic":"Local LLMs","similarity":0.248,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/Local LLMs/2026-07-07/16-update-i-built-a-tool-to-turn-your-claude-code-sessions-into-fine-tuni.md"}]
pros: ["Recently updated (2026-07-24)","Apache-2.0 license","2 GitHub stars","GitHub Actions/CI detected"]
cons: ["No obvious v1 warning, still review upstream code before use"]
readme_quality: 85
has_ci: true
has_tests: true
setup_steps_count: 2
dependency_files: [{"name":"package.json","summary":"deps none; scripts bootstrap, doctor, sync, verify, install-runtime, setup-local-adapter, start-change, release-local"}]
install_commands: ["claude plugin marketplace add https://github.com/Emtemf/enterprise-harness","claude plugin install enterprise-harness@enterprise-harness --scope local","claude plugin marketplace update enterprise-harness","claude plugin update enterprise-harness@enterprise-harness --scope local"]
risk_flags: []
status: "new"
---

# Emtemf/enterprise-harness
...
Dependency files:
- package.json: deps none; scripts bootstrap, doctor, sync, verify, install-runtime, setup-local-adapter, start-change, release-local
