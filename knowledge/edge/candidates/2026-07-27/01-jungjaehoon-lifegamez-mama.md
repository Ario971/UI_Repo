---
id: "jungjaehoon-lifegamez/mama"
name: "jungjaehoon-lifegamez/MAMA"
...
composite: 74
replacement_target: ""
related_articles: [{"title":"Show HN: Abralo – Free, easy way to run several Claude Code agents in one window","date":"2026-07-08","topic":"AI agents","similarity":0.399,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-07-08/07-show-hn-abralo-free-easy-way-to-run-several-claude-code-agents-in-one-.md"},{"title":"Show HN: Two-tier-memory – queryable long-term memory for AI coding agents","date":"2026-07-05","topic":"AI agents","similarity":0.332,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-07-05/06-show-hn-two-tier-memory-queryable-long-term-memory-for-ai-coding-agent.md"},{"title":"Kuberwastaken/VPSmaxxing","date":"2026-06-30","topic":"AI dev tools","similarity":0.295,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-06-30/13-kuberwastaken-vpsmaxxing.md"}]
pros: ["Recently updated (2026-07-27)","MIT license","12 GitHub stars","GitHub Actions/CI detected"]
...
has_tests: true
setup_steps_count: 3
dependency_files: [{"name":"package.json","summary":"deps mime-types, @typescript-eslint/eslint-plugin, @typescript-eslint/parser, eslint, eslint-config-prettier, husky, lint-staged, prettier; scripts test, build, clean, typecheck, test:affected, build:affected, lint, lint:fix"}]
install_commands: ["claude auth status   # or: codex login — if authenticated, you're ready","claude auth login   # or: codex login","npx @jungjaehoon/mama-os init","git clone https://github.com/jungjaehoon-lifegamez/MAMA.git","pnpm test     # 3000+ tests across all packages"]
...
Dependency files:
- package.json: deps mime-types, @typescript-eslint/eslint-plugin, @typescript-eslint/parser, eslint, eslint-config-prettier, husky, lint-staged, prettier; scripts test, build, clean, typecheck, test:affected, build:affected, lint, lint:fix
