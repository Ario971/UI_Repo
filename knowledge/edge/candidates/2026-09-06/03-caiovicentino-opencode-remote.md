---
id: "caiovicentino/opencode-remote"
name: "caiovicentino/opencode-remote"
...
composite: 71
replacement_target: ""
related_articles: [{"title":"caiovicentino/opencode-remote","date":"2026-09-06","topic":"AI dev tools","similarity":0.766,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-09-06/12-caiovicentino-opencode-remote.md"},{"title":"Bennyoooo/write-like-me","date":"2026-08-06","topic":"AI agents","similarity":0.286,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-06/06-bennyoooo-write-like-me.md"},{"title":"Show HN: Parley – your coding agent can talk to a teammate's agent","date":"2026-08-11","topic":"AI agents","similarity":0.262,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-11/06-show-hn-parley-your-coding-agent-can-talk-to-a-teammate-s-agent.md"}]
pros: ["Recently updated (2026-09-06)","AGPL-3.0 license","6 GitHub stars","GitHub Actions/CI detected"]
cons: ["Integration may take more than a quick install","README includes remote script execution pattern","README mentions credentials or API tokens"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 4
dependency_files: [{"name":"package.json","summary":"deps eslint, eslint-plugin-react-hooks, playwright-core, typescript-eslint; scripts dev:web, dev:relay, dev:daemon, start:desktop, build, typecheck, lint, test:unit"}]
install_commands: ["git clone https://github.com/caiovicentino/opencode-remote.git","npm run build --workspace @ocr/web","docker pull ghcr.io/caiovicentino/opencode-remote:0.2.0   # pin the version, not latest","npm run build --workspace @ocr/web       # build the UI once","npm run build --workspace @ocr/desktop   # compile the shell (TypeScript main process)","npm start  --workspace @ocr/desktop      # open the window"]
risk_flags: ["README includes remote script execution pattern","README mentions credentials or API tokens"]
status: "new"
---

# caiovicentino/opencode-remote

Control your local opencode agent from your phone — PWA ⇄ blind relay ⇄ daemon. Passkey+QR pairing, E2E-encrypted, voice, rewind, AutoMode, push notifications.

URL: https://github.com/caiovicentino/opencode-remote

## Why it matters
You saved an article on 2026-09-06 about AI dev tools; this candidate overlaps with "caiovicentino/opencode-remote" and may turn that reading into a practical workflow improvement.
...
Dependency files:
- package.json: deps eslint, eslint-plugin-react-hooks, playwright-core, typescript-eslint; scripts dev:web, dev:relay, dev:daemon, start:desktop, build, typecheck, lint, test:unit
