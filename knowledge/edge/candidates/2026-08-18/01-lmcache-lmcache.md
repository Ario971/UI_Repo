...
replacement_target: ""
related_articles: []
pros: ["Recently updated (2026-08-18)","Apache-2.0 license","11194 GitHub stars","GitHub Actions/CI detected"]
cons: ["README mentions credentials or API tokens"]
readme_quality: 100
has_ci: true
has_tests: false
setup_steps_count: 1
dependency_files: [{"name":"pyproject.toml","summary":"python project; deps requires, packaging, setuptools, setuptools_scm, torch, build-backend, name, authors"}]
install_commands: ["pip install lmcache"]
...
## Why it matters
LMCache/LMCache matches your AI development source filters and scored strongly enough to review before it disappears into the daily noise.
...
Dependency files:
- pyproject.toml: python project; deps requires, packaging, setuptools, setuptools_scm, torch, build-backend, name, authors
