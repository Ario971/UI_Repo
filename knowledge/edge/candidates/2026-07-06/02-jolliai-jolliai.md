...
composite: 76
replacement_target: ""
related_articles: [{"title":"Show HN: Two-tier-memory – queryable long-term memory for AI coding agents","date":"2026-07-05","topic":"AI agents","similarity":0.243,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-07-05/06-show-hn-two-tier-memory-queryable-long-term-memory-for-ai-coding-agent.md"},{"title":"sciencebanda09/nexus-multiagent","date":"2026-06-23","topic":"AI dev tools","similarity":0.224,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-06-23/10-sciencebanda09-nexus-multiagent.md"},{"title":"Show HN: Deep Memory – Vocabulary-driven graph memory for AI agents","date":"2026-06-09","topic":"AI agents","similarity":0.203,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-06-09/57-show-hn-deep-memory-vocabulary-driven-graph-memory-for-ai-agents.md"}]
pros: ["Recently updated (2026-07-06)","Apache-2.0 license","104 GitHub stars","GitHub Actions/CI detected"]
cons: ["README mentions telemetry/analytics"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 3
dependency_files: [{"name":"package.json","summary":"deps none; scripts build, build:cli, build:vscode, typecheck, typecheck:cli, typecheck:vscode, lint, lint:cli"}]
install_commands: ["npm install -g @jolli.ai/site-cli","npm install","npm run build        # builds both CLI and VS Code","npm run typecheck","npm run lint","npm run test"]
...
## Why it matters
You saved an article on 2026-07-05 about AI agents; this candidate overlaps with "Show HN: Two-tier-memory – queryable long-term memory for AI coding agents" and may turn that reading into a practical workflow improvement.

## Pros
+ Recently updated (2026-07-06)
+ Apache-2.0 license
+ 104 GitHub stars
...
Dependency files:
- package.json: deps none; scripts build, build:cli, build:vscode, typecheck, typecheck:cli, typecheck:vscode, lint, lint:cli
...
- **Ask your AI agent about past work** — `jolli mcp` exposes your history to AI agents over the Model Context Protocol (five tools: search, recall, decision timeline, list branches, build a PR description), so Claude Code can query memories and even draft a PR without leaving the conversation. Registered automatically when Jolli Memory is enabled.
