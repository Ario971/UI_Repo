...
composite: 84
replacement_target: ""
related_articles: [{"title":"Show HN: Boxes.dev: ditch localhost; run Claude Code and Codex in the cloud","date":"2026-06-04","topic":"AI agents","similarity":0.316,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-06-04/10-show-hn-boxes-dev-ditch-localhost-run-claude-code-and-codex-in-the-clo.md"},{"title":"isla4ever/design-lens","date":"2026-06-29","topic":"AI dev tools","similarity":0.311,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-06-29/11-isla4ever-design-lens.md"},{"title":"AlexNthLab/nth-dao","date":"2026-06-12","topic":"AI dev tools","similarity":0.292,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-06-12/97-alexnthlab-nth-dao.md"}]
pros: ["Recently updated (2026-06-29)","Apache-2.0 license","72646 GitHub stars","GitHub Actions/CI detected"]
cons: ["README mentions credentials or API tokens","README mentions telemetry/analytics","Docker privileged mode mentioned"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 3
dependency_files: [{"name":"package.json","summary":"deps @open-design/components, @open-design/daemon, @open-design/tools-dev, @open-design/tools-pack, @open-design/tools-release, @open-design/tools-serve, @types/node, tsx; scripts postinstall, tools-dev, tools-pack, tools-release, tools-serve, nix:update-hash, guard, lint:craft"}]
install_commands: ["git clone https://github.com/nexu-io/open-design.git","docker compose up -d","pnpm tools-dev run web","pnpm guard && pnpm --filter @open-design/plugin-runtime typecheck","pnpm guard && pnpm typecheck","pnpm --filter @open-design/<package> test"]
risk_flags: ["README mentions credentials or API tokens","README mentions telemetry/analytics","Docker privileged mode mentioned"]
status: "new"
---
...
## Why it matters
You saved an article on 2026-06-04 about AI agents; this candidate overlaps with "Show HN: Boxes.dev: ditch localhost; run Claude Code and Codex in the cloud" and may turn that reading into a practical workflow improvement.

## Pros
+ Recently updated (2026-06-29)
+ Apache-2.0 license
+ 72646 GitHub stars
...
- Docker privileged mode mentioned
...
Dependency files:
- package.json: deps @open-design/components, @open-design/daemon, @open-design/tools-dev, @open-design/tools-pack, @open-design/tools-release, @open-design/tools-serve, @types/node, tsx; scripts postinstall, tools-dev, tools-pack, tools-release, tools-serve, nix:update-hash, guard, lint:craft
