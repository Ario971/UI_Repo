...
url: "https://github.com/kentwynn/KGraph"
date: "2026-06-29"
...
composite: 68
replacement_target: ""
related_articles: [{"title":"Show HN: Cost.dev (YC W21) – making agents cost-aware and cheaper to call","date":"2026-06-04","topic":"AI agents","similarity":0.362,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-06-04/09-show-hn-cost-dev-yc-w21-making-agents-cost-aware-and-cheaper-to-call.md"},{"title":"LuD1161/agentjail","date":"2026-06-23","topic":"AI dev tools","similarity":0.328,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-06-23/12-lud1161-agentjail.md"},{"title":"Show HN: Boxes.dev: ditch localhost; run Claude Code and Codex in the cloud","date":"2026-06-04","topic":"AI agents","similarity":0.324,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-06-04/10-show-hn-boxes-dev-ditch-localhost-run-claude-code-and-codex-in-the-clo.md"}]
pros: ["Recently updated (2026-06-29)","MIT license","3 GitHub stars","GitHub Actions/CI detected"]
...
has_tests: true
setup_steps_count: 4
dependency_files: [{"name":"package.json","summary":"deps @clack/prompts, chalk, commander, fast-glob, typescript, web-tree-sitter, yaml, @release-it/conventional-changelog; scripts clean, build, postbuild, test, kgraph, check:artifacts, pack:dry, release:pack"}]
install_commands: ["npm install -g @kentwynn/kgraph@latest","npx @kentwynn/kgraph@latest init","npx @kentwynn/kgraph@latest \"auth token refresh\"","npm install","npm run build","npm test"]
...
Dependency files:
- package.json: deps @clack/prompts, chalk, commander, fast-glob, typescript, web-tree-sitter, yaml, @release-it/conventional-changelog; scripts clean, build, postbuild, test, kgraph, check:artifacts, pack:dry, release:pack
