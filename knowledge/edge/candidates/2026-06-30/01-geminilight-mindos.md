...
composite: 79
replacement_target: ""
related_articles: [{"title":"sciencebanda09/nexus-multiagent","date":"2026-06-23","topic":"AI dev tools","similarity":0.317,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-06-23/10-sciencebanda09-nexus-multiagent.md"},{"title":"Towards an Agent-First Web: Redesigning the Web for AI Agents","date":"2026-06-17","topic":"AI agents","similarity":0.296,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-06-17/67-towards-an-agent-first-web-redesigning-the-web-for-ai-agents.md"},{"title":"tyanko-lab/agents-mission-control","date":"2026-05-28","topic":"AI agents","similarity":0.29,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-05-28/12-tyanko-lab-agents-mission-control.md"}]
pros: ["Recently updated (2026-06-30)","MIT license","640 GitHub stars","GitHub Actions/CI detected"]
...
has_tests: true
setup_steps_count: 3
dependency_files: [{"name":"package.json","summary":"deps chokidar, @eslint/js, @playwright/test, @types/node, eslint, eslint-plugin-react-hooks, globals, tsx; scripts setup, dev, build, start, mcp, test, test:quick, test:release"}]
install_commands: ["npm install -g @geminilight/mindos@latest","git clone https://github.com/GeminiLight/MindOS","pnpm install","pnpm --filter @geminilight/mindos build","pnpm link --global   # registers the `mindos` command globally","npx skills add https://github.com/GeminiLight/MindOS --skill mindos -g -y      # English"]
...
Dependency files:
- package.json: deps chokidar, @eslint/js, @playwright/test, @types/node, eslint, eslint-plugin-react-hooks, globals, tsx; scripts setup, dev, build, start, mcp, test, test:quick, test:release
