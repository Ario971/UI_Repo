---
id: "jyt6640/persona-harness"
name: "jyt6640/persona-harness"
...
composite: 71
replacement_target: ""
related_articles: [{"title":"Show HN: Cost.dev (YC W21) – making agents cost-aware and cheaper to call","date":"2026-06-04","topic":"AI agents","similarity":0.277,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-06-04/09-show-hn-cost-dev-yc-w21-making-agents-cost-aware-and-cheaper-to-call.md"},{"title":"Show HN: TBD, a Mac-native CLI-forward coding agent multiplexer","date":"2026-06-26","topic":"AI agents","similarity":0.249,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-06-26/07-show-hn-tbd-a-mac-native-cli-forward-coding-agent-multiplexer.md"},{"title":"Show HN: AMA2, messenger built for AI agent","date":"2026-06-30","topic":"AI agents","similarity":0.214,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-06-30/06-show-hn-ama2-messenger-built-for-ai-agent.md"}]
pros: ["Recently updated (2026-06-30)","Apache-2.0 license","11 GitHub stars","GitHub Actions/CI detected"]
cons: ["README includes remote script execution pattern"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 3
dependency_files: [{"name":"package.json","summary":"deps @opencode-ai/plugin, @types/node, typescript, vitest; scripts clean, build, prepack, check:docs, check:injection-value, experiment:phase0, experiment:phase0:prepare, experiment:phase0:step2-3"}]
install_commands: ["npm install -g opencode-ai","npm init -y","npm install -D persona-harness@next","npx ph --help","npx ph init","npx ph doctor"]
...
OpenCode plugin and CLI that guides AI agents through cleaner backend generation workflows Harness.
...
Dependency files:
- package.json: deps @opencode-ai/plugin, @types/node, typescript, vitest; scripts clean, build, prepack, check:docs, check:injection-value, experiment:phase0, experiment:phase0:prepare, experiment:phase0:step2-3
