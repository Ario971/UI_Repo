---
id: "sonarsource/sonarqube-cli"
name: "SonarSource/sonarqube-cli"
...
composite: 73
replacement_target: ""
related_articles: [{"title":"Show HN: Keen Code – an agentic-engineered coding agent","date":"2026-08-10","topic":"AI agents","similarity":0.315,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-10/06-show-hn-keen-code-an-agentic-engineered-coding-agent.md"},{"title":"LamsonRetail/lsr-agent-platform","date":"2026-08-18","topic":"AI dev tools","similarity":0.253,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-08-18/13-lamsonretail-lsr-agent-platform.md"},{"title":"Show HN: Try Benzi – A coding harness/agent beating Claude Code itself on Sonnet","date":"2026-08-08","topic":"AI agents","similarity":0.239,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-08/08-show-hn-try-benzi-a-coding-harness-agent-beating-claude-code-itself-on.md"}]
pros: ["Recently updated (2026-09-09)","274 GitHub stars","GitHub Actions/CI detected","README mentions tests or validation"]
...
has_tests: true
setup_steps_count: 5
dependency_files: [{"name":"package.json","summary":"deps @clack/core, @sentry/bun, @toon-format/toon, commander, js-yaml, launchdarkly-node-client-sdk, node-forge, openpgp; scripts build:binary, postbuild:binary, dev, test:unit, pretest:integration, test:integration, test:all, test:e2e"}]
install_commands: ["git config --global core.hooksPath","git commit"]
...
Dependency files:
- package.json: deps @clack/core, @sentry/bun, @toon-format/toon, commander, js-yaml, launchdarkly-node-client-sdk, node-forge, openpgp; scripts build:binary, postbuild:binary, dev, test:unit, pretest:integration, test:integration, test:all, test:e2e
