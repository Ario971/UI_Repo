---
id: "kotsur69/luna-core-hud"
name: "Kotsur69/Luna-Core-HUD"
url: "https://github.com/Kotsur69/Luna-Core-HUD"
date: "2026-09-21"
...
composite: 72
replacement_target: ""
related_articles: [{"title":"how to setup llama.cpp and blender to make lovely 3d stuff together","date":"2026-08-28","topic":"Local LLMs","similarity":0.203,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/Local LLMs/2026-08-28/16-how-to-setup-llama-cpp-and-blender-to-make-lovely-3d-stuff-together.md"},{"title":"Show HN: Hands-Rust MCP/CLI that sees the Windows desktop and clicks real Chrome","date":"2026-08-23","topic":"AI dev tools","similarity":0.183,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-08-23/11-show-hn-hands-rust-mcp-cli-that-sees-the-windows-desktop-and-clicks-re.md"}]
pros: ["Recently updated (2026-09-21)","MIT license","1 GitHub stars","README mentions tests or validation"]
cons: ["README mentions credentials or API tokens","README mentions telemetry/analytics"]
readme_quality: 100
has_ci: false
has_tests: true
setup_steps_count: 4
dependency_files: [{"name":"package.json","summary":"deps @lydell/node-pty, @xterm/addon-fit, @xterm/xterm, electron-updater, electron, electron-builder; scripts start, test, dist, pack"}]
install_commands: ["git clone https://github.com/Kotsur69/Luna-Core-HUD.git","npm install","npm start","npx electron . --luna-probe     # remounts every widget 3×, prints bus","npm test        # node --test — 1182 tests, ~0.9s, no extra dependencies","npx electron . --enable-logging   # pipes the renderer console to your terminal"]
...
Dependency files:
- package.json: deps @lydell/node-pty, @xterm/addon-fit, @xterm/xterm, electron-updater, electron, electron-builder; scripts start, test, dist, pack
