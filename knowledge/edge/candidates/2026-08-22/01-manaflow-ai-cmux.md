...
composite: 79
replacement_target: ""
related_articles: [{"title":"Bennyoooo/write-like-me","date":"2026-08-06","topic":"AI agents","similarity":0.308,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-06/06-bennyoooo-write-like-me.md"},{"title":"Show HN: Mirafold – Your Agent with Generative UI (Codex, Claude Code, Gemini)","date":"2026-08-07","topic":"AI agents","similarity":0.268,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-07/07-show-hn-mirafold-your-agent-with-generative-ui-codex-claude-code-gemin.md"},{"title":"Show HN: Clixad – Free AI coding agent in the terminal, funded by an offerwall","date":"2026-08-13","topic":"AI agents","similarity":0.265,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-13/09-show-hn-clixad-free-ai-coding-agent-in-the-terminal-funded-by-an-offer.md"}]
pros: ["Recently updated (2026-08-22)","26333 GitHub stars","GitHub Actions/CI detected","Matches 3 saved Feed article(s)"]
cons: ["License was not clearly detected by GitHub","No clear install command found in README"]
readme_quality: 85
has_ci: true
has_tests: false
setup_steps_count: 1
dependency_files: [{"name":"package.json","summary":"deps @opentui/core, prosemirror-commands, prosemirror-model, prosemirror-state, prosemirror-view, react, react-dom, solid-js; scripts agent-session-web:build, agent-session-web:test, biome:check, feed-tui, iroh:relay-catalog:check, iroh:relay-catalog:generate"}]
install_commands: []
risk_flags: []
status: "new"
---
...
Dependency files:
- package.json: deps @opentui/core, prosemirror-commands, prosemirror-model, prosemirror-state, prosemirror-view, react, react-dom, solid-js; scripts agent-session-web:build, agent-session-web:test, biome:check, feed-tui, iroh:relay-catalog:check, iroh:relay-catalog:generate
