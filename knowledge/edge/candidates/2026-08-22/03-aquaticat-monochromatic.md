---
id: "aquaticat/monochromatic"
name: "Aquaticat/Monochromatic"
...
composite: 72
replacement_target: ""
related_articles: [{"title":"Show HN: Zaivern Code – a Rust cockpit for parallel AI coding agents","date":"2026-08-07","topic":"AI agents","similarity":0.281,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-07/06-show-hn-zaivern-code-a-rust-cockpit-for-parallel-ai-coding-agents.md"},{"title":"Show HN: Mint MCP – Generate 3D assets from coding agents","date":"2026-08-04","topic":"AI agents","similarity":0.22,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-04/06-show-hn-mint-mcp-generate-3d-assets-from-coding-agents.md"},{"title":"Show HN: Claude-account – switch Claude Code accounts without logging in again","date":"2026-07-30","topic":"AI dev tools","similarity":0.209,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-07-30/12-show-hn-claude-account-switch-claude-code-accounts-without-logging-in-.md"}]
pros: ["Recently updated (2026-08-22)","LGPL-3.0 license","5 GitHub stars","GitHub Actions/CI detected"]
cons: ["Integration may take more than a quick install"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 3
dependency_files: [{"name":"package.json","summary":"deps h3, @monochromatic-dev/cli-mvm, @monochromatic-dev/git-policy-cli, @monochromatic-dev/cli-git-clone-size, @monochromatic-dev/cli-terminal-exec, @monochromatic-dev/cli-wg-allowedips, @monochromatic-dev/cli-wg-quicker, @monochromatic-dev/cli-open-code-review-issue; scripts none"}]
install_commands: ["git clone https://github.com/Aquaticat/Monochromatic.git","claude-code-plugin/       Claude Code plugins and hooks (guardrail, statusline,","git-policy/               Policy-aware git wrapper, policy authoring API,","npm run","pnpm exec"]
risk_flags: []
status: "new"
---
...
## Why it matters
You saved an article on 2026-08-07 about AI agents; this candidate overlaps with "Show HN: Zaivern Code – a Rust cockpit for parallel AI coding agents" and may turn that reading into a practical workflow improvement.

## Pros
+ Recently updated (2026-08-22)
+ LGPL-3.0 license
+ 5 GitHub stars
...
Dependency files:
- package.json: deps h3, @monochromatic-dev/cli-mvm, @monochromatic-dev/git-policy-cli, @monochromatic-dev/cli-git-clone-size, @monochromatic-dev/cli-terminal-exec, @monochromatic-dev/cli-wg-allowedips, @monochromatic-dev/cli-wg-quicker, @monochromatic-dev/cli-open-code-review-issue; scripts none
