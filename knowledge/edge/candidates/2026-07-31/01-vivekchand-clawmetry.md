...
composite: 75
replacement_target: ""
related_articles: [{"title":"Agent-Native Immune System: Architecture, Taxonomy, and Engineering","date":"2026-06-26","topic":"AI agents","similarity":0.295,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-06-26/06-agent-native-immune-system-architecture-taxonomy-and-engineering.md"},{"title":"Show HN: OneCLI – OSS credential gateway that keeps secrets out of AI agents","date":"2026-07-23","topic":"AI agents","similarity":0.282,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-07-23/07-show-hn-onecli-oss-credential-gateway-that-keeps-secrets-out-of-ai-age.md"},{"title":"Show HN: Reverse-engineering web apps into agent tools","date":"2026-07-09","topic":"AI agents","similarity":0.273,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-07-09/07-show-hn-reverse-engineering-web-apps-into-agent-tools.md"}]
pros: ["Recently updated (2026-07-31)","MIT license","393 GitHub stars","GitHub Actions/CI detected"]
...
has_tests: true
setup_steps_count: 6
dependency_files: [{"name":"package.json","summary":"deps none; scripts deploy, deploy:landing"},{"name":"requirements.txt","summary":"deps flask>=3.1.3,<4, duckdb>=1.5.5  # local event store (epic #964 phase 1), pytest>=9.1.1, pytest-playwright>=0.8.0, requests>=2.34.2"}]
install_commands: ["pip install clawmetry && clawmetry","pip install clawmetry","git clone https://github.com/vivekchand/clawmetry.git","npm ci","npm run dev","npm run build"]
...
CI detected: yes
Tests mentioned: yes
Setup steps estimate: 6

Dependency files:
- package.json: deps none; scripts deploy, deploy:landing
- requirements.txt: deps flask>=3.1.3,<4, duckdb>=1.5.5  # local event store (epic #964 phase 1), pytest>=9.1.1, pytest-playwright>=0.8.0, requests>=2.34.2
...
- An AI agent runtime on the same machine: OpenClaw, NVIDIA NemoClaw, Claude Code, Codex, Cursor, Goose, Hermes, opencode, Qwen Code, Aider, NanoClaw, PicoClaw, Pi, Deep Agents, or n8n (or mounted volumes for Docker)
- Linux or macOS
