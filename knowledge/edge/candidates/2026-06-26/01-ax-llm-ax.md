...
composite: 81
replacement_target: ""
related_articles: [{"title":"sciencebanda09/nexus-multiagent","date":"2026-06-23","topic":"AI dev tools","similarity":0.207,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-06-23/10-sciencebanda09-nexus-multiagent.md"}]
pros: ["Recently updated (2026-06-26)","Apache-2.0 license","2794 GitHub stars","GitHub Actions/CI detected"]
...
install_commands: ["npm run example -- list","npm run example -- python src/examples/python/generation/axgen-openai.py","npm run example -- java src/examples/java/generation/BasicGenerationExample.java","npm run example -- cpp src/examples/cpp/generation/basic_generation.cpp","npm run example -- go src/examples/go/generation/basic_generation.go","npm run example -- rust src/examples/rust/generation/basic_generation.rs"]
