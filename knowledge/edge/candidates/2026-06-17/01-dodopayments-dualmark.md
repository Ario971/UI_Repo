---
id: "dodopayments/dualmark"
name: "dodopayments/dualmark"
url: "https://github.com/dodopayments/dualmark"
date: "2026-06-17"
...
composite: 74
replacement_target: ""
related_articles: [{"title":"jhwreal/wechat-article-pipeline-skill","date":"2026-05-28","topic":"AI agents","similarity":0.182,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-05-28/13-jhwreal-wechat-article-pipeline-skill.md"},{"title":"greetingromansoldier/agora-perp-agent","date":"2026-06-13","topic":"AI agents","similarity":0.18,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-06-13/06-greetingromansoldier-agora-perp-agent.md"}]
pros: ["Recently updated (2026-06-17)","Apache-2.0 license","88 GitHub stars","GitHub Actions/CI detected"]
...
has_tests: true
setup_steps_count: 4
dependency_files: [{"name":"package.json","summary":"deps @changesets/cli, @types/node, @vitest/coverage-v8, prettier, tsup, turbo, typescript, vitest; scripts build, test, typecheck, lint, format, format:check, changeset, version-packages"}]
install_commands: ["npm i @dualmark/core","npm i @dualmark/converters","npm i @dualmark/astro","npm i @dualmark/nextjs","npm i @dualmark/sveltekit","npm i @dualmark/cloudflare"]
...
Dependency files:
- package.json: deps @changesets/cli, @types/node, @vitest/coverage-v8, prettier, tsup, turbo, typescript, vitest; scripts build, test, typecheck, lint, format, format:check, changeset, version-packages

Install commands found:
- npm i @dualmark/core
- npm i @dualmark/converters
- npm i @dualmark/astro
- npm i @dualmark/nextjs
- npm i @dualmark/sveltekit
