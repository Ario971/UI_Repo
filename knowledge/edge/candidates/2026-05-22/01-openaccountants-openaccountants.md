...
replacement_target: ""
related_articles: []
pros: ["Recently updated (2026-05-22)","AGPL-3.0 license","69 GitHub stars","README mentions tests or validation"]
...
setup_steps_count: 4
dependency_files: []
install_commands: ["Claude: calls list_jurisdictions → sees \"malta\"","Claude: calls list_files(\"malta\") → foundation.md, malta-vat.md, …","Claude: calls get_file(\"malta\", \"foundation.md\") → full skill loaded","Claude: processes your bank statement with the correct tax rules","git clone https://github.com/openaccountants/openaccountants.git","pip install ./mcp          # requires Python 3.10+"]
risk_flags: []
status: "new"
---
...
## Why it matters
openaccountants/openaccountants matches your AI development source filters and scored strongly enough to review before it disappears into the daily noise.
