---
id: "bdaskbot-maker/bdask-super-ai-complete"
name: "bdaskbot-maker/bdask-super-ai-complete"
url: "https://github.com/bdaskbot-maker/bdask-super-ai-complete"
date: "2026-05-22"
...
composite: 69
replacement_target: ""
related_articles: [{"title":"Show HN: Dari-docs – Optimize your docs using parallel coding agents","date":"2026-05-20","topic":"AI agents","similarity":0.218,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-05-20/14-show-hn-dari-docs-optimize-your-docs-using-parallel-coding-agents.md"}]
pros: ["Recently updated (2026-05-22)","MIT license","GitHub Actions/CI detected","README mentions tests or validation"]
cons: ["README mentions credentials or API tokens","Repository description is sparse"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 3
dependency_files: [{"name":"package.json","summary":"deps @eslint/eslintrc, @google/generative-ai, @radix-ui/react-avatar, @radix-ui/react-dialog, @radix-ui/react-dropdown-menu, @radix-ui/react-scroll-area, @radix-ui/react-separator, @radix-ui/react-slot; scripts dev, build, start, lint, api:dev, api:start, test"}]
install_commands: ["git clone https://github.com/bdaskbot-maker/bdask-super-ai.git","npm install","npm run dev","npm start","docker-compose up -d","docker-compose logs -f app"]
risk_flags: ["README mentions credentials or API tokens"]
status: "new"
---

# bdaskbot-maker/bdask-super-ai-complete
...
Dependency files:
- package.json: deps @eslint/eslintrc, @google/generative-ai, @radix-ui/react-avatar, @radix-ui/react-dialog, @radix-ui/react-dropdown-menu, @radix-ui/react-scroll-area, @radix-ui/react-separator, @radix-ui/react-slot; scripts dev, build, start, lint, api:dev, api:start, test
