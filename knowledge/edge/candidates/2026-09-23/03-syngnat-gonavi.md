...
composite: 76
replacement_target: ""
related_articles: [{"title":"Show HN: DataZen – a local-first client for cross-database workflows","date":"2026-08-29","topic":"AI dev tools","similarity":0.283,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-08-29/10-show-hn-datazen-a-local-first-client-for-cross-database-workflows.md"},{"title":"Show HN: MCP Tool Definition Quality Score (TDQS) Spec","date":"2026-09-03","topic":"AI dev tools","similarity":0.239,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-09-03/10-show-hn-mcp-tool-definition-quality-score-tdqs-spec.md"},{"title":"how to setup llama.cpp and blender to make lovely 3d stuff together","date":"2026-08-28","topic":"Local LLMs","similarity":0.236,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/Local LLMs/2026-08-28/16-how-to-setup-llama-cpp-and-blender-to-make-lovely-3d-stuff-together.md"}]
pros: ["Recently updated (2026-09-23)","Apache-2.0 license","1905 GitHub stars","GitHub Actions/CI detected"]
...
has_tests: true
setup_steps_count: 3
dependency_files: [{"name":"go.mod","summary":"module GoNavi-Wails"}]
install_commands: ["go install github.com/wailsapp/wails/v2/cmd/wails@v2.15.0","git clone https://github.com/Syngnat/GoNavi.git","docker compose --env-file docker.cli.env -f docker-compose.cli.yml run --rm gonavi-cli list-connections","go build .","docker compose --env-file docker.web-server.env -f docker-compose.web-server.yml up -d","docker compose --env-file docker.web-server.env -f docker-compose.web-server.yml up -d --force-recreate"]
...
## Why it matters
You saved an article on 2026-08-29 about AI dev tools; this candidate overlaps with "Show HN: DataZen – a local-first client for cross-database workflows" and may turn that reading into a practical workflow improvement.
