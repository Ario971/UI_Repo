...
composite: 74
replacement_target: ""
related_articles: [{"title":"Show HN: AMA2, messenger built for AI agent","date":"2026-06-30","topic":"AI agents","similarity":0.392,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-06-30/06-show-hn-ama2-messenger-built-for-ai-agent.md"},{"title":"Show HN: ctx – Search the coding agent history already on your machine","date":"2026-07-02","topic":"AI agents","similarity":0.338,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-07-02/07-show-hn-ctx-search-the-coding-agent-history-already-on-your-machine.md"},{"title":"sciencebanda09/nexus-multiagent","date":"2026-06-23","topic":"AI dev tools","similarity":0.338,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-06-23/10-sciencebanda09-nexus-multiagent.md"}]
pros: ["Recently updated (2026-07-22)","MIT license","59 GitHub stars","GitHub Actions/CI detected"]
...
has_tests: true
setup_steps_count: 4
dependency_files: [{"name":"package.json","summary":"deps @types/node, @types/react, @types/react-dom, @types/ws, @vitejs/plugin-react, esbuild, tsx, typescript; scripts build, build:cli, check, lint, optimize, start, test, typecheck"}]
install_commands: ["npx @taewooopark/agent-blackbox up --host claude-code","npx @taewooopark/agent-blackbox up --host codex","npx @taewooopark/agent-blackbox up","npx @taewooopark/agent-blackbox up --host all","claude            # Claude Code, in any folder — zero setup, just run it","codex              # Codex CLI (desktop-app tasks are captured too)"]
...
## Why it matters
You saved an article on 2026-06-30 about AI agents; this candidate overlaps with "Show HN: AMA2, messenger built for AI agent" and may turn that reading into a practical workflow improvement.
...
Dependency files:
- package.json: deps @types/node, @types/react, @types/react-dom, @types/ws, @vitejs/plugin-react, esbuild, tsx, typescript; scripts build, build:cli, check, lint, optimize, start, test, typecheck
