---
id: "lifekit-hq/devclaw"
name: "lifekit-hq/devclaw"
url: "https://github.com/lifekit-hq/devclaw"
date: "2026-08-31"
...
composite: 70
replacement_target: ""
related_articles: [{"title":"Show HN: ResiliReplay - Chaos testing for AI agents and MCP servers","date":"2026-07-31","topic":"AI agents","similarity":0.331,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-07-31/09-show-hn-resilireplay-chaos-testing-for-ai-agents-and-mcp-servers.md"},{"title":"Show HN: Itsuki – open-source memory engine for AI agents (API and MCP)","date":"2026-08-29","topic":"AI agents","similarity":0.297,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-29/06-show-hn-itsuki-open-source-memory-engine-for-ai-agents-api-and-mcp.md"},{"title":"Show HN: Open tool for testing your AI Agents (No LLM)","date":"2026-08-28","topic":"AI agents","similarity":0.294,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-28/06-show-hn-open-tool-for-testing-your-ai-agents-no-llm.md"}]
pros: ["Recently updated (2026-08-31)","MIT license","1 GitHub stars","GitHub Actions/CI detected"]
...
has_tests: true
setup_steps_count: 3
dependency_files: [{"name":"pyproject.toml","summary":"python project; deps name, version, description, requires-python, dependencies, fastmcp, httpx, pyyaml"}]
install_commands: ["pip install -e .","pip install -r runner/requirements.txt   # only inside the sandbox image","npm install -g @agentclientprotocol/claude-agent-acp","pip install -e \".[dev]\"","docker run --rm","claude --print"]
...
Autonomous software-development loop behind MCP — durable goals, sandboxed execution, gated verification, self-merged PRs. Driven from chat via OpenClaw.
...
Dependency files:
- pyproject.toml: python project; deps name, version, description, requires-python, dependencies, fastmcp, httpx, pyyaml
