---
id: "gordonkjlee/openmemory"
name: "gordonkjlee/openmemory"
...
composite: 68
replacement_target: ""
related_articles: [{"title":"Show HN: Itsuki – open-source memory engine for AI agents (API and MCP)","date":"2026-08-29","topic":"AI agents","similarity":0.401,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-29/06-show-hn-itsuki-open-source-memory-engine-for-ai-agents-api-and-mcp.md"},{"title":"Show HN: Mnemosyne Local hierarchical memory engine for AI agents (MCP Native)","date":"2026-08-23","topic":"AI agents","similarity":0.388,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-23/06-show-hn-mnemosyne-local-hierarchical-memory-engine-for-ai-agents-mcp-n.md"},{"title":"how to setup llama.cpp and blender to make lovely 3d stuff together","date":"2026-08-28","topic":"Local LLMs","similarity":0.384,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/Local LLMs/2026-08-28/16-how-to-setup-llama-cpp-and-blender-to-make-lovely-3d-stuff-together.md"}]
pros: ["Recently updated (2026-08-31)","MIT license","2 GitHub stars","GitHub Actions/CI detected"]
...
has_tests: true
setup_steps_count: 3
dependency_files: [{"name":"package.json","summary":"deps @modelcontextprotocol/sdk, pg, @electric-sql/pglite, @eslint/js, @types/node, @types/pg, eslint, typescript; scripts build, watch, test, test:semantic, test:first-fact, test:coding-store, test:watch, lint"}]
install_commands: ["git clone https://github.com/gordonkjlee/openmemory","npm install","npm run build","npm test","claude -p","npx -y @openmem/mcp"]
...
Dependency files:
- package.json: deps @modelcontextprotocol/sdk, pg, @electric-sql/pglite, @eslint/js, @types/node, @types/pg, eslint, typescript; scripts build, watch, test, test:semantic, test:first-fact, test:coding-store, test:watch, lint
