---
id: "italanta/opencrane"
name: "italanta/opencrane"
url: "https://github.com/italanta/opencrane"
date: "2026-06-03"
...
composite: 69
replacement_target: ""
related_articles: [{"title":"dui14/vibe-coding-workflow","date":"2026-05-30","topic":"AI dev tools","similarity":0.188,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-05-30/39-dui14-vibe-coding-workflow.md"},{"title":"Show HN: Agent Chat Bridge – give AI IDE agents an async callback","date":"2026-05-21","topic":"AI agents","similarity":0.187,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-05-21/27-show-hn-agent-chat-bridge-give-ai-ide-agents-an-async-callback.md"}]
pros: ["Recently updated (2026-06-03)","2 GitHub stars","GitHub Actions/CI detected","README mentions tests or validation"]
...
has_tests: true
setup_steps_count: 2
dependency_files: [{"name":"package.json","summary":"deps none; scripts build, dev, test, test:e2e:k3d, test:phase1, install:phase1:local, install:phase1:gcp, wizard"}]
install_commands: ["pnpm install","pnpm build","pnpm test"]
...
Give your staff claw-like wings 🦀🐦‍🔥. OpenCrane wraps OpenClaw with organisational awareness and control. Provide a personal AI agent to all your staff in a sovereign, secure and low-cost way.
...
Dependency files:
- package.json: deps none; scripts build, dev, test, test:e2e:k3d, test:phase1, install:phase1:local, install:phase1:gcp, wizard
