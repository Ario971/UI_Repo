---
id: "g-digital-by-garrigues/ead-factory-mcp"
name: "g-digital-by-Garrigues/EAD-Factory-MCP"
...
composite: 70
replacement_target: ""
related_articles: [{"title":"gHashTag/trios-mcp-rag","date":"2026-05-23","topic":"AI agents","similarity":0.238,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-05-23/53-ghashtag-trios-mcp-rag.md"}]
pros: ["Recently updated (2026-06-03)","MIT license","GitHub Actions/CI detected","README includes install commands"]
cons: ["Integration may take more than a quick install","README mentions credentials or API tokens"]
readme_quality: 100
has_ci: true
has_tests: false
setup_steps_count: 2
dependency_files: [{"name":"package.json","summary":"deps @modelcontextprotocol/sdk, axios, dotenv, express, zod, @types/express, @types/node, ts-node; scripts build, dev, start"}]
install_commands: ["npx -y @g-digital/mcp-ead-factory","docker pull gdigital/ead-factory:latest"]
...
Dependency files:
- package.json: deps @modelcontextprotocol/sdk, axios, dotenv, express, zod, @types/express, @types/node, ts-node; scripts build, dev, start

Install commands found:
- npx -y @g-digital/mcp-ead-factory
- docker pull gdigital/ead-factory:latest
