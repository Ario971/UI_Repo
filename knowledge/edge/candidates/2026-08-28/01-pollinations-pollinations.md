...
composite: 76
replacement_target: ""
related_articles: [{"title":"LamsonRetail/lsr-agent-platform","date":"2026-08-18","topic":"AI dev tools","similarity":0.187,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-08-18/13-lamsonretail-lsr-agent-platform.md"}]
pros: ["Recently updated (2026-08-28)","MIT license","5002 GitHub stars","GitHub Actions/CI detected"]
...
has_tests: true
setup_steps_count: 4
dependency_files: [{"name":"package.json","summary":"deps wrangler, zod, @biomejs/biome, concurrently; scripts install:all, install:services, install:packages, build:sdk, dev, dev:enter, dev:gen, dev:gen-stack"}]
install_commands: ["npx @pollinations/cli gen image \"cyberpunk city at night\" --model flux --output city.png","npx @pollinations/cli gen text \"Explain quantum tunneling in one sentence\"","npx @pollinations/cli gen audio \"Hello world\" --voice nova --output speech.mp3","npx @pollinations/cli gen video \"a waterfall in slow motion\" --duration 5 --output clip.mp4","npx @pollinations/cli gen transcribe speech.mp3","npx @pollinations/mcp"]
...
Dependency files:
- package.json: deps wrangler, zod, @biomejs/biome, concurrently; scripts install:all, install:services, install:packages, build:sdk, dev, dev:enter, dev:gen, dev:gen-stack
