---
id: "buihongduc132/pi-acp-agents"
name: "buihongduc132/pi-acp-agents"
url: "https://github.com/buihongduc132/pi-acp-agents"
date: "2026-07-05"
...
composite: 71
replacement_target: ""
related_articles: [{"title":"Show HN: Cost.dev (YC W21) – making agents cost-aware and cheaper to call","date":"2026-06-04","topic":"AI agents","similarity":0.307,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-06-04/09-show-hn-cost-dev-yc-w21-making-agents-cost-aware-and-cheaper-to-call.md"},{"title":"Show HN: AMA2, messenger built for AI agent","date":"2026-06-30","topic":"AI agents","similarity":0.294,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-06-30/06-show-hn-ama2-messenger-built-for-ai-agent.md"},{"title":"greetingromansoldier/agora-perp-agent","date":"2026-06-13","topic":"AI agents","similarity":0.287,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-06-13/06-greetingromansoldier-agora-perp-agent.md"}]
pros: ["Recently updated (2026-07-05)","MIT license","4 GitHub stars","GitHub Actions/CI detected"]
cons: ["README mentions credentials or API tokens","README mentions telemetry/analytics"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 5
dependency_files: [{"name":"package.json","summary":"deps @agentclientprotocol/sdk, pi-acp-types, @mariozechner/pi-coding-agent, @mariozechner/pi-tui, @types/node, @vitest/coverage-v8, typebox, typescript; scripts test, test:ci, test:watch, typecheck, prepublishOnly, prepack, postpack, version"}]
install_commands: ["npm install @buihongduc132/pi-acp-agents","npm install","npm test              # all tests","npm run test:ci       # with coverage","npm run typecheck     # TypeScript validation","npm run publish:dry   # verify package contents before publish"]
...
Dependency files:
- package.json: deps @agentclientprotocol/sdk, pi-acp-types, @mariozechner/pi-coding-agent, @mariozechner/pi-tui, @types/node, @vitest/coverage-v8, typebox, typescript; scripts test, test:ci, test:watch, typecheck, prepublishOnly, prepack, postpack, version
