---
id: "getty104/claude-task-worker"
name: "getty104/claude-task-worker"
url: "https://github.com/getty104/claude-task-worker"
date: "2026-07-05"
...
composite: 73
replacement_target: ""
related_articles: [{"title":"Kuberwastaken/VPSmaxxing","date":"2026-06-30","topic":"AI dev tools","similarity":0.37,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-06-30/13-kuberwastaken-vpsmaxxing.md"},{"title":"AlexNthLab/nth-dao","date":"2026-06-12","topic":"AI dev tools","similarity":0.309,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-06-12/97-alexnthlab-nth-dao.md"},{"title":"llm011/ethan-agent","date":"2026-06-20","topic":"AI dev tools","similarity":0.289,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-06-20/93-llm011-ethan-agent.md"}]
pros: ["Recently updated (2026-07-05)","MIT license","2 GitHub stars","GitHub Actions/CI detected"]
cons: ["Repository description is sparse"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 5
dependency_files: [{"name":"package.json","summary":"deps @eslint/js, @types/node, esbuild, eslint, eslint-config-prettier, prettier, typescript, typescript-eslint; scripts build, dev, lint, lint:fix, format, format:check, prepublishOnly"}]
install_commands: ["npx claude-task-worker install","npm install -g claude-task-worker","npm install","npm run build","npm link","claude plugin marketplace add getty104/claude-task-worker"]
risk_flags: []
status: "new"
---

# getty104/claude-task-worker
...
Dependency files:
- package.json: deps @eslint/js, @types/node, esbuild, eslint, eslint-config-prettier, prettier, typescript, typescript-eslint; scripts build, dev, lint, lint:fix, format, format:check, prepublishOnly
