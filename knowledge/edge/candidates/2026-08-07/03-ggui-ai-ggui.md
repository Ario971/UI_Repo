...
composite: 74
replacement_target: ""
related_articles: [{"title":"Show HN: Reverse-engineering web apps into agent tools","date":"2026-07-09","topic":"AI agents","similarity":0.305,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-07-09/07-show-hn-reverse-engineering-web-apps-into-agent-tools.md"},{"title":"What Does It Take to Detect an AI Agent? Minimal Feature Sets for Behavioral Detection under Browser Automation","date":"2026-07-29","topic":"AI agents","similarity":0.28,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-07-29/09-what-does-it-take-to-detect-an-ai-agent-minimal-feature-sets-for-behav.md"},{"title":"superduperlarry/enosone","date":"2026-07-05","topic":"AI agents","similarity":0.269,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-07-05/07-superduperlarry-enosone.md"}]
pros: ["Recently updated (2026-08-07)","Apache-2.0 license","39 GitHub stars","GitHub Actions/CI detected"]
cons: ["Integration may take more than a quick install","README mentions credentials or API tokens"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 3
dependency_files: [{"name":"package.json","summary":"deps @changesets/changelog-github, @changesets/cli; scripts build, typecheck, test, lint, changeset, version, release"}]
install_commands: ["git clone https://github.com/ggui-ai/ggui && cd ggui","pnpm install","pnpm dev                     # starts ggui + MCP servers + agent + web, then opens the app","npm install -g @ggui-ai/cli","pnpm dev","pnpm dev --verbose"]
...
Dependency files:
- package.json: deps @changesets/changelog-github, @changesets/cli; scripts build, typecheck, test, lint, changeset, version, release
...
| [`@ggui-ai/react`](./packages/ggui-react)               | React embedding — chat shells + MCP-Apps chat hook                 | [![npm](https://img.shields.io/npm/v/@ggui-ai/react)](https://npmjs.com/package/@ggui-ai/react)               |
| [`@ggui-ai/react-native`](./packages/ggui-react-native) | React Native embedding — `<McpAppIframe>` MCP-Apps host + shells   | [![npm](https://img.shields.io/npm/v/@ggui-ai/react-native)](https://npmjs.com/package/@ggui-ai/react-native) |
