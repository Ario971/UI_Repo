---
id: "mroops0111/openapi-mcp-gateway"
name: "mroops0111/openapi-mcp-gateway"
url: "https://github.com/mroops0111/openapi-mcp-gateway"
date: "2026-09-03"
...
composite: 71
replacement_target: ""
related_articles: [{"title":"how to setup llama.cpp and blender to make lovely 3d stuff together","date":"2026-08-28","topic":"Local LLMs","similarity":0.411,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/Local LLMs/2026-08-28/16-how-to-setup-llama-cpp-and-blender-to-make-lovely-3d-stuff-together.md"},{"title":"qgeng1465/bio-mcp","date":"2026-08-11","topic":"AI dev tools","similarity":0.355,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-08-11/13-qgeng1465-bio-mcp.md"},{"title":"Show HN: Keen Code – an agentic-engineered coding agent","date":"2026-08-10","topic":"AI agents","similarity":0.285,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-10/06-show-hn-keen-code-an-agentic-engineered-coding-agent.md"}]
pros: ["Recently updated (2026-09-03)","MIT license","3 GitHub stars","GitHub Actions/CI detected"]
cons: ["Integration may take more than a quick install","README mentions credentials or API tokens"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 5
dependency_files: [{"name":"pyproject.toml","summary":"python project; deps name, version, description, authors, readme, license, requires-python, keywords"}]
install_commands: ["uv add openapi-mcp-gateway","uv add \"openapi-mcp-gateway[redis]\"   # optional, Redis token store for multi-replica OAuth","uv run openapi-mcp-gateway --spec https://petstore3.swagger.io/api/v3/openapi.json --name petstore","uv run openapi-mcp-gateway \\","uv run","uv run openapi-mcp-gateway --config servers.yml"]
...
Turn any OpenAPI/Swagger API into an MCP server with real OAuth2 support. Multi-spec gateway for Claude, Cursor, Codex, and other MCP clients.
...
Dependency files:
- pyproject.toml: python project; deps name, version, description, authors, readme, license, requires-python, keywords
