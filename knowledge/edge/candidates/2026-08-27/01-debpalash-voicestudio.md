...
composite: 80
replacement_target: ""
related_articles: [{"title":"Bennyoooo/write-like-me","date":"2026-08-06","topic":"AI agents","similarity":0.266,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-06/06-bennyoooo-write-like-me.md"},{"title":"[audio.cpp] Release 0.5: DramaBox expressive TTS, Confucius4 cross-lingual voice transfer, plus 7 more models and ROCm/HIP","date":"2026-08-01","topic":"Local LLMs","similarity":0.211,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/Local LLMs/2026-08-01/16-audio-cpp-release-0-5-dramabox-expressive-tts-confucius4-cross-lingual.md"}]
pros: ["Recently updated (2026-08-27)","AGPL-3.0 license","11833 GitHub stars","GitHub Actions/CI detected"]
...
has_tests: true
setup_steps_count: 4
dependency_files: [{"name":"package.json","summary":"deps concurrently, playwright, taze, turbo, typescript, wait-on; scripts setup:api, dev:api, dev:frontend, dev:desktop, wait:api, wait:frontend, predev, dev"},{"name":"pyproject.toml","summary":"python project; deps requires, build-backend, name, version, description, readme, license, requires-python"}]
install_commands: ["git clone https://github.com/debpalash/VoiceStudio.git","npx skills add debpalash/omnivoice-studio","uv run python backend/main.py --diagnose --deep"]
...
Dependency files:
- package.json: deps concurrently, playwright, taze, turbo, typescript, wait-on; scripts setup:api, dev:api, dev:frontend, dev:desktop, wait:api, wait:frontend, predev, dev
