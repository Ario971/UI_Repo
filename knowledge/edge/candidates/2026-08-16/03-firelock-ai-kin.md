...
composite: 72
replacement_target: ""
related_articles: [{"title":"Show HN: ResiliReplay - Chaos testing for AI agents and MCP servers","date":"2026-07-31","topic":"AI agents","similarity":0.275,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-07-31/09-show-hn-resilireplay-chaos-testing-for-ai-agents-and-mcp-servers.md"},{"title":"attestral-labs/attestral","date":"2026-07-18","topic":"AI dev tools","similarity":0.265,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-07-18/11-attestral-labs-attestral.md"},{"title":"Show HN: I built a native app for coding agents with Rust and GPUI","date":"2026-08-16","topic":"AI agents","similarity":0.259,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-16/09-show-hn-i-built-a-native-app-for-coding-agents-with-rust-and-gpui.md"}]
pros: ["Recently updated (2026-08-16)","Apache-2.0 license","45 GitHub stars","GitHub Actions/CI detected"]
...
has_tests: true
setup_steps_count: 3
dependency_files: [{"name":"package.json","summary":"deps none; scripts lint:packages, test:packages, publish:boundary-contracts"},{"name":"Cargo.toml","summary":"Rust project metadata detected"}]
install_commands: ["git[\"Git<br/>import and export boundary\"]","npm install -g @kinlab/kin@latest","codex plugin marketplace add firelock-ai/kin","codex plugin add kin@kin"]
...
Dependency files:
- package.json: deps none; scripts lint:packages, test:packages, publish:boundary-contracts
