...
composite: 86
replacement_target: ""
related_articles: [{"title":"Show HN: Claude-account – switch Claude Code accounts without logging in again","date":"2026-07-30","topic":"AI dev tools","similarity":0.392,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-07-30/12-show-hn-claude-account-switch-claude-code-accounts-without-logging-in-.md"},{"title":"Bennyoooo/write-like-me","date":"2026-08-06","topic":"AI agents","similarity":0.292,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-06/06-bennyoooo-write-like-me.md"},{"title":"Show HN: Wienerdog – memory and self-improving skills for Claude Code/Codex","date":"2026-08-01","topic":"AI agents","similarity":0.26,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-01/08-show-hn-wienerdog-memory-and-self-improving-skills-for-claude-code-cod.md"}]
pros: ["Recently updated (2026-08-16)","MIT license","2642 GitHub stars","GitHub Actions/CI detected"]
cons: ["README mentions credentials or API tokens","README mentions telemetry/analytics"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 2
dependency_files: [{"name":"package.json","summary":"deps @commitlint/cli, @commitlint/config-conventional, @eslint/js, @intentsolutions/audit-harness, @intentsolutions/core, @intentsolutions/jrig-cli, @types/node, ajv; scripts dev, build, test, lint, typecheck, validate:greptile, sync-marketplace, sync-marketplace:json-only"}]
install_commands: ["pnpm add -g @intentsolutionsio/ccpi    # Install the CLI","pnpm add -g @intentsolutionsio/ccpi","pip install anthropic"]
...
Dependency files:
- package.json: deps @commitlint/cli, @commitlint/config-conventional, @eslint/js, @intentsolutions/audit-harness, @intentsolutions/core, @intentsolutions/jrig-cli, @types/node, ajv; scripts dev, build, test, lint, typecheck, validate:greptile, sync-marketplace, sync-marketplace:json-only
