---
id: "tuo-lei/vibe-replay"
name: "tuo-lei/vibe-replay"
...
composite: 72
replacement_target: ""
related_articles: [{"title":"Show HN: Agent-estimate, how long a coding task takes, at agent speed","date":"2026-05-21","topic":"AI agents","similarity":0.316,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-05-21/40-show-hn-agent-estimate-how-long-a-coding-task-takes-at-agent-speed.md"},{"title":"Show HN: Cost.dev (YC W21) – making agents cost-aware and cheaper to call","date":"2026-06-04","topic":"AI agents","similarity":0.315,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-06-04/09-show-hn-cost-dev-yc-w21-making-agents-cost-aware-and-cheaper-to-call.md"},{"title":"dui14/vibe-coding-workflow","date":"2026-05-30","topic":"AI dev tools","similarity":0.285,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-05-30/39-dui14-vibe-coding-workflow.md"}]
pros: ["Recently updated (2026-06-06)","MIT license","28 GitHub stars","GitHub Actions/CI detected"]
cons: ["README mentions credentials or API tokens","README mentions telemetry/analytics"]
readme_quality: 100
has_ci: true
has_tests: false
setup_steps_count: 5
dependency_files: [{"name":"package.json","summary":"deps @hono/node-server, hono, lefthook, oxfmt, oxlint, playwright, tsx, typescript; scripts build, build:website, start, dev, dev:menu, dev:dashboard, dev:website, test"}]
install_commands: ["npx vibe-replay","npx skills add tuo-lei/vibe-replay --skill replay -g","git clone https://github.com/tuo-lei/vibe-replay.git","pnpm install","pnpm dev              # Viewer (Vite HMR) + CLI (auto-restart) — full HMR","pnpm dev:website      # Website (Astro HMR) + Viewer (Vite HMR)"]
...
Dependency files:
- package.json: deps @hono/node-server, hono, lefthook, oxfmt, oxlint, playwright, tsx, typescript; scripts build, build:website, start, dev, dev:menu, dev:dashboard, dev:website, test
