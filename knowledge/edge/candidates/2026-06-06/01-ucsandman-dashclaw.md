...
composite: 78
replacement_target: ""
related_articles: [{"title":"dui14/vibe-coding-workflow","date":"2026-05-30","topic":"AI dev tools","similarity":0.222,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-05-30/39-dui14-vibe-coding-workflow.md"},{"title":"Show HN: Agent-estimate, how long a coding task takes, at agent speed","date":"2026-05-21","topic":"AI agents","similarity":0.217,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-05-21/40-show-hn-agent-estimate-how-long-a-coding-task-takes-at-agent-speed.md"},{"title":"Show HN: Open Envelope – an open schema for defining AI agent teams","date":"2026-05-28","topic":"AI agents","similarity":0.216,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-05-28/61-show-hn-open-envelope-an-open-schema-for-defining-ai-agent-teams.md"}]
pros: ["Recently updated (2026-06-06)","MIT license","273 GitHub stars","GitHub Actions/CI detected"]
...
install_commands: ["npm run hooks:install","npm install dashclaw     # Node 18+","pip install dashclaw     # Python 3.7+","npm install @dashclaw/openclaw-plugin","npx dashclaw-demo","npm install dashclaw   # or: pip install dashclaw"]
...
## Why it matters
You saved an article on 2026-05-30 about AI dev tools; this candidate overlaps with "dui14/vibe-coding-workflow" and may turn that reading into a practical workflow improvement.
...
Every governance primitive is reachable as HTTP. The stable contract is pinned in [`docs/openapi/critical-stable.openapi.json`](./docs/openapi/critical-stable.openapi.json); the full inventory (**289 routes**: 47 stable, 24 beta, 218 experimental) is at [`docs/api-inventory.md`](./docs/api-inventory.md). Webhook events include `signal.detected`, `decision.created`, `action.created`, `lost_confirmation`, and the rest of the catalog — configurable per org.
