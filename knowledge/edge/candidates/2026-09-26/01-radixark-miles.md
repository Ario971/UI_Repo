...
composite: 75
replacement_target: ""
related_articles: [{"title":"Show HN: Open tool for testing your AI Agents (No LLM)","date":"2026-08-28","topic":"AI agents","similarity":0.259,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-28/06-show-hn-open-tool-for-testing-your-ai-agents-no-llm.md"}]
pros: ["Recently updated (2026-09-26)","Apache-2.0 license","2998 GitHub stars","GitHub Actions/CI detected"]
cons: ["No clear install command found in README","README mentions credentials or API tokens"]
readme_quality: 70
has_ci: true
has_tests: false
setup_steps_count: 1
dependency_files: [{"name":"pyproject.toml","summary":"python project; deps requires, setuptools, build-backend, profile, line_length, ignore_whitespace, py_version, sections"},{"name":"requirements.txt","summary":"deps accelerate, backports.strenum; python_version < \"3.11\", blake3==1.0.9  # disk-delta weight sync (checksum), blobfile, datasets, httpx[http2], hypothesis>=5.40, kubernetes_asyncio"}]
install_commands: []
...
Dependency files:
- pyproject.toml: python project; deps requires, setuptools, build-backend, profile, line_length, ignore_whitespace, py_version, sections
- requirements.txt: deps accelerate, backports.strenum; python_version < "3.11", blake3==1.0.9  # disk-delta weight sync (checksum), blobfile, datasets, httpx[http2], hypothesis>=5.40, kubernetes_asyncio
