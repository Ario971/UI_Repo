---
id: "denameidina/hanoman"
name: "denameidina/hanoman"
url: "https://github.com/denameidina/hanoman"
date: "2026-09-26"
...
composite: 71
replacement_target: ""
related_articles: [{"title":"Show HN: An open-source control plane for your company's AI agents","date":"2026-09-14","topic":"AI agents","similarity":0.228,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-09-14/06-show-hn-an-open-source-control-plane-for-your-company-s-ai-agents.md"},{"title":"Show HN: Recurse – Develop and deploy specialist agents faster","date":"2026-09-25","topic":"AI agents","similarity":0.221,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-09-25/06-show-hn-recurse-develop-and-deploy-specialist-agents-faster.md"},{"title":"Show HN: Itsuki – open-source memory engine for AI agents (API and MCP)","date":"2026-08-29","topic":"AI agents","similarity":0.204,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-29/06-show-hn-itsuki-open-source-memory-engine-for-ai-agents-api-and-mcp.md"}]
pros: ["Recently updated (2026-09-26)","MIT license","13 GitHub stars","GitHub Actions/CI detected"]
cons: ["README mentions credentials or API tokens"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 3
dependency_files: [{"name":"package.json","summary":"deps tsx, typescript, vitest; scripts dev, dev:api, dev:web, db:generate, db:migrate, prod:setup, prod:api, prod"}]
install_commands: ["npm i -g hanoman","pnpm install    # postinstall men-generate Prisma Client dari server/prisma/schema.prisma","pnpm dev        # API (:8787) + dashboard (:5173)","npx hanoman","pnpm add -g hanoman","yarn global add hanoman"]
...
## Why it matters
You saved an article on 2026-09-14 about AI agents; this candidate overlaps with "Show HN: An open-source control plane for your company's AI agents" and may turn that reading into a practical workflow improvement.

## Pros
+ Recently updated (2026-09-26)
+ MIT license
+ 13 GitHub stars
...
Dependency files:
- package.json: deps tsx, typescript, vitest; scripts dev, dev:api, dev:web, db:generate, db:migrate, prod:setup, prod:api, prod
...
| **Tim** | kerja **manusia** di sekitar sesi agen — papan kanban empat kolom (assignee, tenggat) plus linimasa Gantt rencana |
