---
id: "chat2anyllm/awesome-claude-skills"
name: "Chat2AnyLLM/awesome-claude-skills"
...
composite: 75
replacement_target: ""
related_articles: [{"title":"Kuberwastaken/VPSmaxxing","date":"2026-06-30","topic":"AI dev tools","similarity":0.429,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-06-30/13-kuberwastaken-vpsmaxxing.md"},{"title":"UPDATE: I built a tool to turn your Claude Code sessions into fine-tuning data for local models (You can now convert your Codex and Pi sessions)","date":"2026-07-07","topic":"Local LLMs","similarity":0.356,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/Local LLMs/2026-07-07/16-update-i-built-a-tool-to-turn-your-claude-code-sessions-into-fine-tuni.md"},{"title":"Show HN: Abralo – Free, easy way to run several Claude Code agents in one window","date":"2026-07-08","topic":"AI agents","similarity":0.341,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-07-08/07-show-hn-abralo-free-easy-way-to-run-several-claude-code-agents-in-one-.md"}]
pros: ["Recently updated (2026-07-18)","142 GitHub stars","GitHub Actions/CI detected","Matches 3 saved Feed article(s)"]
cons: ["License was not clearly detected by GitHub","No clear install command found in README","README mentions credentials or API tokens"]
readme_quality: 77
has_ci: true
has_tests: false
setup_steps_count: 0
dependency_files: [{"name":"requirements.txt","summary":"deps PyYAML>=5.4.0"}]
install_commands: []
...
Dependency files:
- requirements.txt: deps PyYAML>=5.4.0
...
- Enabled source repositories: **1732**
- Discoverable skills: **95,852**
- Healthy repos: **1694** · Truncated: **1** · Unavailable: **37**
...
| [AgenticPawan/FullStack-Pilot](https://github.com/AgenticPawan/FullStack-Pilot) | 150 | `master` | `.` | ✅ ok |  |
...
| [Amey-Thakur/AI-SKILLS](https://github.com/Amey-Thakur/AI-SKILLS) | 28 | `main` | `skills` | ✅ ok |  |
...
| [anchit-choudhry/gryffin-calorai](https://github.com/anchit-choudhry/gryffin-calorai) | 41 | `main` | `.` | ✅ ok |  |
...
| [andresnator/agents-orchestrator](https://github.com/andresnator/agents-orchestrator) | 79 | `main` | `skills` | ✅ ok |  |
...
| [artokun/comfyui-mcp](https://github.com/artokun/comfyui-mcp) | 33 | `main` | `.` | ✅ ok |  |
...
| [atretyak1985/swarmery](https://github.com/atretyak1985/swarmery) | 57 | `main` | `.` | ✅ ok |  |
...
| [bg-szy/TOP-SKILLS](https://github.com/bg-szy/TOP-SKILLS) | 8,449 | `master` | `skills` | ✅ ok |  |
...
| [bitjaru/styleseed](https://github.com/bitjaru/styleseed) | 20 | `main` | `.` | ✅ ok |  |
...
| [Borda/AI-Rig](https://github.com/Borda/AI-Rig) | 49 | `main` | `.` | ✅ ok |  |
...
| [broomva/skills](https://github.com/broomva/skills) | 80 | `main` | `skills` | ✅ ok |  |
...
| [buildproven/claude-kit](https://github.com/buildproven/claude-kit) | 35 | `main` | `skills` | ✅ ok |  |
...
| [CitiesSkylinesModding/agents-plugins](https://github.com/CitiesSkylinesModding/agents-plugins) | 4 | `main` | `.` | ✅ ok |  |
...
| [davila7/claude-code-templates](https://github.com/davila7/claude-code-templates) | 885 | `main` | `.` | ✅ ok |  |
| [daymade/claude-code-skills](https://github.com/daymade/claude-code-skills) | 88 | `main` | `.` | ✅ ok |  |
...
| [deciqAI/knowledge-skills](https://github.com/deciqAI/knowledge-skills) | 228 | `main` | `.` | ✅ ok |  |
...
| [dryvist/claude-code-plugins](https://github.com/dryvist/claude-code-plugins) | 47 | `main` | `.` | ✅ ok |  |
...
| [Fectivnfy112357/camofox-shim](https://github.com/Fectivnfy112357/camofox-shim) | 1 | `master` | `skills` | ✅ ok |  |
...
| [gooseworks-ai/goose-skills](https://github.com/gooseworks-ai/goose-skills) | 255 | `main` | `skills` | ✅ ok |  |
| [gordon1210/agent-goodies](https://github.com/gordon1210/agent-goodies) | 6 | `main` | `.` | ✅ ok |  |
...
| [hamza-ali-shahjahan/hamzaish](https://github.com/hamza-ali-shahjahan/hamzaish) | 115 | `main` | `.` | ✅ ok |  |
...
| [hanzhcn/laohan-skills](https://github.com/hanzhcn/laohan-skills) | 16 | `main` | `.` | ✅ ok |  |
...
| [home-dev-lab/workflow-toolbox](https://github.com/home-dev-lab/workflow-toolbox) | 6 | `main` | `.` | ✅ ok |  |
...
| [Ian-Louw/potion](https://github.com/Ian-Louw/potion) | 11 | `main` | `skills` | ✅ ok |  |
...
| [JasonColapietro/suede-creator-skills](https://github.com/JasonColapietro/suede-creator-skills) | 25 | `main` | `skills` | ✅ ok |  |
| [JasonWarrenUK/goblin-mode](https://github.com/JasonWarrenUK/goblin-mode) | 45 | `main` | `skills` | ✅ ok |  |
...
| [jmagar/apprise-rmcp](https://github.com/jmagar/apprise-rmcp) | 2 | `main` | `.` | ✅ ok |  |
...
| [Kanevry/session-orchestrator](https://github.com/Kanevry/session-orchestrator) | 44 | `main` | `skills` | ✅ ok |  |
...
| [kbichave/deep-plan-enhanced](https://github.com/kbichave/deep-plan-enhanced) | 3 | `main` | `skills` | ✅ ok |  |
...
| [livevil7/creeta-lens](https://github.com/livevil7/creeta-lens) | 12 | `master` | `skills` | ✅ ok |  |
...
| [manhquydev/flow-skill](https://github.com/manhquydev/flow-skill) | 2 | `master` | `.` | ✅ ok |  |
...
| [MarkkaMiikka/claude-finnish-skills](https://github.com/MarkkaMiikka/claude-finnish-skills) | 15 | `main` | `.claude/skills` | ✅ ok |  |
...
| [mikeprasad/aria-knowledge](https://github.com/mikeprasad/aria-knowledge) | 133 | `main` | `.` | ✅ ok |  |
...
| [mimukit/skills](https://github.com/mimukit/skills) | 6 | `main` | `skills` | ✅ ok |  |
...
| [mohitagw15856/pm-claude-skills](https://github.com/mohitagw15856/pm-claude-skills) | 1,739 | `main` | `.` | ✅ ok |  |
...
| [naveedharri/benai-skills](https://github.com/naveedharri/benai-skills) | 313 | `develop` | `.` | ✅ ok |  |
...
| [NexaDuo/mARC](https://github.com/NexaDuo/mARC) | 6 | `main` | `.` | ✅ ok |  |
...
| [nyldn/claude-octopus](https://github.com/nyldn/claude-octopus) | 111 | `main` | `.` | ✅ ok |  |
| [oaris-dev/diviops](https://github.com/oaris-dev/diviops) | 2 | `main` | `skills` | ✅ ok |  |
| [oaustegard/claude-skills](https://github.com/oaustegard/claude-skills) | 148 | `main` | `.` | ✅ ok |  |
...
| [okisdev/claude-code-fusion](https://github.com/okisdev/claude-code-fusion) | 20 | `main` | `.` | ✅ ok |  |
...
| [ommakes/Skills](https://github.com/ommakes/Skills) | 12 | `main` | `.` | ✅ ok |  |
...
| [OutlineDriven/odin-claude-plugin](https://github.com/OutlineDriven/odin-claude-plugin) | 101 | `main` | `skills` | ✅ ok |  |
...
| [PostHog/ai-plugin](https://github.com/PostHog/ai-plugin) | 124 | `main` | `skills` | ✅ ok |  |
...
| [prvthmpcypher/skills-design](https://github.com/prvthmpcypher/skills-design) | 26 | `main` | `skills` | ✅ ok |  |
...
| [qxbyte/pluginhub](https://github.com/qxbyte/pluginhub) | 14 | `main` | `.` | ✅ ok |  |
...
| [rgourley/quant-garage](https://github.com/rgourley/quant-garage) | 58 | `main` | `skills` | ✅ ok |  |
...
| [royvergara/design-team-os](https://github.com/royvergara/design-team-os) | 17 | `main` | `skills` | ✅ ok |  |
...
| [s977043/river-review](https://github.com/s977043/river-review) | 123 | `main` | `skills` | ✅ ok |  |
...
| [saurabhshuklagrowisto/saurabh-ai-systems](https://github.com/saurabhshuklagrowisto/saurabh-ai-systems) | 9 | `main` | `.` | ✅ ok |  |
...
| [seldonframe/seldonframe](https://github.com/seldonframe/seldonframe) | 26 | `main` | `.` | ✅ ok |  |
...
| [sherifabdlnaby/skills](https://github.com/sherifabdlnaby/skills) | 11 | `main` | `skills` | ✅ ok |  |
...
| [sickn33/agentic-awesome-skills](https://github.com/sickn33/agentic-awesome-skills) | 6,223 | `main` | `.` | ✅ ok |  |
...
| [smk-labs/claude-plugins](https://github.com/smk-labs/claude-plugins) | 10 | `main` | `.` | ✅ ok |  |
...
| [Srltas/claude-skills](https://github.com/Srltas/claude-skills) | 13 | `main` | `.` | ✅ ok |  |
...
| [stealth-engine/skills](https://github.com/stealth-engine/skills) | 17 | `main` | `skills` | ✅ ok |  |
...
| [Tamircohen28/tamirs-superpowers](https://github.com/Tamircohen28/tamirs-superpowers) | 30 | `master` | `skills` | ✅ ok |  |
...
| [TheEdoRan/skills](https://github.com/TheEdoRan/skills) | 3 | `main` | `skills` | ✅ ok |  |
...
| [uwuclxdy/agenticat](https://github.com/uwuclxdy/agenticat) | 15 | `main` | `skills` | ✅ ok |  |
...
| [valorisa/Claude-Skills](https://github.com/valorisa/Claude-Skills) | 27 | `main` | `skills` | ✅ ok |  |
...
| [waqas1412/claude-harness](https://github.com/waqas1412/claude-harness) | 6 | `main` | `.` | ✅ ok |  |
...
| [xr843/Master-skill](https://github.com/xr843/Master-skill) | 19 | `main` | `.` | ✅ ok |  |
...
| [YasuakiOmokawa/skills](https://github.com/YasuakiOmokawa/skills) | 20 | `main` | `.` | ✅ ok |  |
...
| [zx029w/zhuangxiu-skills](https://github.com/zx029w/zhuangxiu-skills) | 12 | `main` | `.` | ✅ ok |  |
...
| [SylphxAI/skills](https://github.com/SylphxAI/skills) | 0 | `main` | `skills` | ❌ missing | HTTP 404 |
