---
id: "tboome33/obsidian-mcp-router"
name: "tboome33/obsidian-mcp-router"
url: "https://github.com/tboome33/obsidian-mcp-router"
date: "2026-07-18"
...
composite: 71
replacement_target: ""
related_articles: [{"title":"Show HN: Local MCP – Claude/ChatGPT read your iMessage, Teams, files on-device","date":"2026-07-05","topic":"AI agents","similarity":0.328,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-07-05/09-show-hn-local-mcp-claude-chatgpt-read-your-imessage-teams-files-on-dev.md"},{"title":"Kuberwastaken/VPSmaxxing","date":"2026-06-30","topic":"AI dev tools","similarity":0.295,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-06-30/13-kuberwastaken-vpsmaxxing.md"},{"title":"UPDATE: I built a tool to turn your Claude Code sessions into fine-tuning data for local models (You can now convert your Codex and Pi sessions)","date":"2026-07-07","topic":"Local LLMs","similarity":0.268,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/Local LLMs/2026-07-07/16-update-i-built-a-tool-to-turn-your-claude-code-sessions-into-fine-tuni.md"}]
pros: ["Recently updated (2026-07-18)","Apache-2.0 license","1 GitHub stars","GitHub Actions/CI detected"]
...
has_tests: true
setup_steps_count: 6
dependency_files: [{"name":"package.json","summary":"deps @modelcontextprotocol/sdk, defuddle, mathml-to-latex, repomix, undici; scripts start, test, setup-vault, bump, status, audit:bridge-readiness, backfill-log, install-markitdown"}]
install_commands: ["git clone https://github.com/tboome33/obsidian-mcp-router.git","npm install","npm link    # makes the `obsidian-mcp-router` binary available globally","claude","npm link    # rend le binaire `obsidian-mcp-router` accessible globalement","npm run setup-vault -- \"<vault-path>\""]
...
Dependency files:
- package.json: deps @modelcontextprotocol/sdk, defuddle, mathml-to-latex, repomix, undici; scripts start, test, setup-vault, bump, status, audit:bridge-readiness, backfill-log, install-markitdown
...
<p align="center">
  ...
  <a href="./CHANGELOG.md"><img src="https://img.shields.io/badge/version-0.47.0-blueviolet.svg" alt="version"></a>
</p>
...
| Context & graph | `get_wiki_context_pack`, `build_wiki_graph`, `build_wiki_tour`, `get_page_neighbors`, `wiki_path`, `build_open_link` |
...
| Contexte & graphe | `get_wiki_context_pack`, `build_wiki_graph`, `build_wiki_tour`, `get_page_neighbors`, `wiki_path`, `build_open_link` |
