---
id: "keboola/agnes-the-ai-analyst"
name: "keboola/agnes-the-ai-analyst"
...
composite: 72
replacement_target: ""
related_articles: [{"title":"sciencebanda09/nexus-multiagent","date":"2026-06-23","topic":"AI dev tools","similarity":0.254,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-06-23/10-sciencebanda09-nexus-multiagent.md"},{"title":"Show HN: Autonomy – Self-Harness/Self-Directed AI Agent Core Under Development","date":"2026-06-20","topic":"AI dev tools","similarity":0.23,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-06-20/94-show-hn-autonomy-self-harness-self-directed-ai-agent-core-under-develo.md"},{"title":"Show HN: Self-hosted voice AI agent for Asterisk/FreePBX","date":"2026-07-13","topic":"AI dev tools","similarity":0.228,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-07-13/13-show-hn-self-hosted-voice-ai-agent-for-asterisk-freepbx.md"}]
pros: ["Recently updated (2026-07-18)","6 GitHub stars","GitHub Actions/CI detected","README mentions tests or validation"]
...
has_tests: true
setup_steps_count: 5
dependency_files: [{"name":"pyproject.toml","summary":"python project; deps name, version, description, requires-python, license, readme, dependencies, duckdb"}]
install_commands: ["git clone https://github.com/keboola/agnes-the-ai-analyst.git","docker compose up","docker compose --profile full up","docker compose -f docker-compose.yml -f docker-compose.prod.yml -f docker-compose.tls.yml \\","uv pip install \".[dev]\""]
...
Agnes — a self-hosted AI harness for your organization: governed data access, skills marketplace, corporate memory, and agent workspaces
...
Dependency files:
- pyproject.toml: python project; deps name, version, description, requires-python, license, readme, dependencies, duckdb
