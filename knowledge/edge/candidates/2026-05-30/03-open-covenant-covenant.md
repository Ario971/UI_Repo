---
id: "open-covenant/covenant"
name: "open-covenant/covenant"
url: "https://github.com/open-covenant/covenant"
date: "2026-05-30"
...
momentum: 57
risk: 32
integration_effort: 70
expected_gain: 87
composite: 69
replacement_target: ""
related_articles: [{"title":"Show HN: Agent.email – sign up via curl, claim with a human OTP","date":"2026-05-21","topic":"AI agents","similarity":0.233,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-05-21/38-show-hn-agent-email-sign-up-via-curl-claim-with-a-human-otp.md"},{"title":"tyanko-lab/agents-mission-control","date":"2026-05-28","topic":"AI agents","similarity":0.227,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-05-28/12-tyanko-lab-agents-mission-control.md"},{"title":"Show HN: Dari-docs – Optimize your docs using parallel coding agents","date":"2026-05-20","topic":"AI agents","similarity":0.225,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-05-20/14-show-hn-dari-docs-optimize-your-docs-using-parallel-coding-agents.md"}]
pros: ["Recently updated (2026-05-30)","Apache-2.0 license","6 GitHub stars","GitHub Actions/CI detected"]
cons: ["Integration may take more than a quick install","README mentions credentials or API tokens"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 3
dependency_files: [{"name":"package.json","summary":"deps @eslint/eslintrc, @types/node, eslint, eslint-config-next, prettier, ts-node, tsx, turbo; scripts agent-os:validate, agent-os:provenance, build, dev, lint, typecheck, clean, test"}]
install_commands: ["git clone https://github.com/open-covenant/covenant && cd covenant","pnpm install --ignore-workspace","pnpm dev   # http://localhost:3000","pnpm --dir landing install --frozen-lockfile --ignore-workspace","pnpm --dir landing build","cargo test --workspace --exclude covenant-settlement-program -- --ignored live_"]
...
## Why it matters
You saved an article on 2026-05-21 about AI agents; this candidate overlaps with "Show HN: Agent.email – sign up via curl, claim with a human OTP" and may turn that reading into a practical workflow improvement.
...
Dependency files:
- package.json: deps @eslint/eslintrc, @types/node, eslint, eslint-config-next, prettier, ts-node, tsx, turbo; scripts agent-os:validate, agent-os:provenance, build, dev, lint, typecheck, clean, test
