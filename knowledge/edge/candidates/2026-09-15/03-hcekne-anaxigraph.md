---
id: "hcekne/anaxigraph"
name: "hcekne/anaxigraph"
url: "https://github.com/hcekne/anaxigraph"
date: "2026-09-15"
...
composite: 70
replacement_target: ""
related_articles: [{"title":"LamsonRetail/lsr-agent-platform","date":"2026-08-18","topic":"AI dev tools","similarity":0.353,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-08-18/13-lamsonretail-lsr-agent-platform.md"},{"title":"pradverma94/ai-support-agent","date":"2026-09-13","topic":"AI dev tools","similarity":0.312,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-09-13/12-pradverma94-ai-support-agent.md"},{"title":"Prime Agent: A Self-Improving RLM Harness","date":"2026-08-24","topic":"AI agents","similarity":0.259,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-24/08-prime-agent-a-self-improving-rlm-harness.md"}]
pros: ["Recently updated (2026-09-15)","Apache-2.0 license","1 GitHub stars","GitHub Actions/CI detected"]
cons: ["README mentions credentials or API tokens"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 4
dependency_files: [{"name":"package.json","summary":"deps @playwright/test; scripts test:visual"},{"name":"pyproject.toml","summary":"python project; deps requires, build-backend, name, version, description, readme, requires-python, license"}]
install_commands: ["codex","codex plugin marketplace add hcekne/anaxigraph && \\","codex plugin add anaxigraph@anaxigraph","claude plugin marketplace add hcekne/anaxigraph && \\","claude plugin install anaxigraph@anaxigraph --scope user","uv sync --extra dev"]
...
Temporal architecture intelligence, observability, and agent context for software repositories.
...
Dependency files:
- package.json: deps @playwright/test; scripts test:visual
