...
composite: 76
replacement_target: ""
related_articles: [{"title":"Show HN: Self-hosted company OS, Claude Code and Codex agents in departments","date":"2026-09-09","topic":"AI agents","similarity":0.346,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-09-09/06-show-hn-self-hosted-company-os-claude-code-and-codex-agents-in-departm.md"},{"title":"MARC v1: An Open-Source Multi-Agent Framework for Clinical AI Reasoning and Coordination","date":"2026-08-13","topic":"AI agents","similarity":0.31,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-13/08-marc-v1-an-open-source-multi-agent-framework-for-clinical-ai-reasoning.md"},{"title":"Show HN: Taurus Agents, my take on multi-agent hierarchies","date":"2026-08-13","topic":"AI agents","similarity":0.289,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-13/07-show-hn-taurus-agents-my-take-on-multi-agent-hierarchies.md"}]
pros: ["Recently updated (2026-09-15)","MIT license","45 GitHub stars","GitHub Actions/CI detected"]
cons: ["README mentions telemetry/analytics"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 4
dependency_files: [{"name":"pyproject.toml","summary":"python project; deps name, version, description, readme, requires-python, license, dependencies, anthropic"}]
install_commands: ["uv venv","uv pip install -e \".[dev]\"","uv run --frozen lefthook install --reset-hooks-path","uv run --frozen lefthook check-install","uv run python build/generate_agents.py"]
...
Dependency files:
- pyproject.toml: python project; deps name, version, description, readme, requires-python, license, dependencies, anthropic
