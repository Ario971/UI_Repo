---
id: "hashevolution/james-rag-evol"
name: "Hashevolution/James-RAG-Evol"
...
composite: 71
replacement_target: ""
related_articles: [{"title":"gHashTag/trios-mcp-rag","date":"2026-05-23","topic":"AI agents","similarity":0.317,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-05-23/53-ghashtag-trios-mcp-rag.md"},{"title":"praveen66ai-66/AGENTIC-_AI_RAG","date":"2026-06-04","topic":"AI dev tools","similarity":0.299,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-06-04/99-praveen66ai-66-agentic-ai-rag.md"},{"title":"vladimir120307-droid/mneme","date":"2026-05-24","topic":"AI dev tools","similarity":0.288,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-05-24/67-vladimir120307-droid-mneme.md"}]
pros: ["Recently updated (2026-06-25)","MIT license","17 GitHub stars","GitHub Actions/CI detected"]
cons: ["Integration may take more than a quick install","README mentions credentials or API tokens"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 6
dependency_files: [{"name":"pyproject.toml","summary":"python project; deps requires, build-backend, name, version, description, readme, requires-python, license"},{"name":"requirements.txt","summary":"deps fastapi>=0.110.0, uvicorn[standard]>=0.27.0, python-multipart>=0.0.27  # GHSA / Dependabot alerts #5,#6 (DoS via unbounded multipart headers; 0.0.27 raises the floor past the newer disclosure), starlette>=1.0.1, pydantic>=2.5.0, python-jose[cryptography]>=3.3.0, passlib[bcrypt]>=1.7.4, python-dotenv>=1.0.0"}]
install_commands: ["git clone https://github.com/Hashevolution/James-RAG-Evol","pip install -r requirements.txt","OLLAMA[\"Ollama<br/>gemma4:e4b default\"]","git clone https://github.com/Hashevolution/James-RAG-Evol.git","pip install"]
...
- requirements.txt: deps fastapi>=0.110.0, uvicorn[standard]>=0.27.0, python-multipart>=0.0.27  # GHSA / Dependabot alerts #5,#6 (DoS via unbounded multipart headers; 0.0.27 raises the floor past the newer disclosure), starlette>=1.0.1, pydantic>=2.5.0, python-jose[cryptography]>=3.3.0, passlib[bcrypt]>=1.7.4, python-dotenv>=1.0.0
