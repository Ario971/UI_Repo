---
id: "gutomec/nirvana-os-engine"
name: "gutomec/nirvana-os-engine"
...
composite: 73
replacement_target: ""
related_articles: [{"title":"Show HN: Mirafold – Your Agent with Generative UI (Codex, Claude Code, Gemini)","date":"2026-08-07","topic":"AI agents","similarity":0.302,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-07/07-show-hn-mirafold-your-agent-with-generative-ui-codex-claude-code-gemin.md"},{"title":"Show HN: Keen Code – an agentic-engineered coding agent","date":"2026-08-10","topic":"AI agents","similarity":0.293,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-10/06-show-hn-keen-code-an-agentic-engineered-coding-agent.md"},{"title":"MARC v1: An Open-Source Multi-Agent Framework for Clinical AI Reasoning and Coordination","date":"2026-08-13","topic":"AI agents","similarity":0.275,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-13/08-marc-v1-an-open-source-multi-agent-framework-for-clinical-ai-reasoning.md"}]
pros: ["Recently updated (2026-08-26)","65 GitHub stars","GitHub Actions/CI detected","README mentions tests or validation"]
cons: ["License was not clearly detected by GitHub","README includes remote script execution pattern"]
readme_quality: 85
has_ci: true
has_tests: true
setup_steps_count: 3
dependency_files: [{"name":"package.json","summary":"deps marked, yaml, zod; scripts install:system, test, validate, glance, check:dispatch, check:purity, check:english, check:coverage"},{"name":"requirements.txt","summary":"deps pydantic>=2.0, pyyaml>=6.0"}]
install_commands: ["npx @nirvana-os/cli"]
...
Nirvana-OS engine: ready-to-run agentic operations. One sentence in, finished work out. Source-available engine for companies, squads and mind-clones. Runtime-agnostic: Claude Code, Codex, Gemini-CLI, Antigravity, Hermes.

URL: https://github.com/gutomec/nirvana-os-engine

## Why it matters
You saved an article on 2026-08-07 about AI agents; this candidate overlaps with "Show HN: Mirafold – Your Agent with Generative UI (Codex, Claude Code, Gemini)" and may turn that reading into a practical workflow improvement.
...
Dependency files:
- package.json: deps marked, yaml, zod; scripts install:system, test, validate, glance, check:dispatch, check:purity, check:english, check:coverage
- requirements.txt: deps pydantic>=2.0, pyyaml>=6.0
