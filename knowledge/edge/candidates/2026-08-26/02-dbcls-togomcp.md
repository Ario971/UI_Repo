...
composite: 75
replacement_target: ""
related_articles: [{"title":"qgeng1465/bio-mcp","date":"2026-08-11","topic":"AI dev tools","similarity":0.347,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-08-11/13-qgeng1465-bio-mcp.md"},{"title":"yearningss/gamemaker-mcp","date":"2026-07-25","topic":"AI dev tools","similarity":0.314,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-07-25/13-yearningss-gamemaker-mcp.md"},{"title":"Show HN: ResiliReplay - Chaos testing for AI agents and MCP servers","date":"2026-07-31","topic":"AI agents","similarity":0.263,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-07-31/09-show-hn-resilireplay-chaos-testing-for-ai-agents-and-mcp-servers.md"}]
pros: ["Recently updated (2026-08-26)","MIT license","11 GitHub stars","GitHub Actions/CI detected"]
...
has_tests: true
setup_steps_count: 4
dependency_files: [{"name":"pyproject.toml","summary":"python project; deps requires, build-backend, where, include, togo_mcp, name, version, description"}]
install_commands: ["git clone https://github.com/dbcls/togomcp.git","uv sync","docker build -t localhost/togo-mcp:latest .         # build main image (tag in .env)","docker compose up -d togomcp-main                   # start main endpoint","docker compose logs -f togomcp-main                 # tail logs","docker compose down                                 # stop and remove all services"]
...
## Why it matters
You saved an article on 2026-08-11 about AI dev tools; this candidate overlaps with "qgeng1465/bio-mcp" and may turn that reading into a practical workflow improvement.
...
Dependency files:
- pyproject.toml: python project; deps requires, build-backend, where, include, togo_mcp, name, version, description
