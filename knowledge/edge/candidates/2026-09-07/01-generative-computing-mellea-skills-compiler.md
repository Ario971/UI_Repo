---
id: "generative-computing/mellea-skills-compiler"
name: "generative-computing/mellea-skills-compiler"
url: "https://github.com/generative-computing/mellea-skills-compiler"
date: "2026-09-07"
...
composite: 78
replacement_target: ""
related_articles: [{"title":"WikiSkill: Compiling Agent Experience into Persistent Knowledge for Skill Evolution","date":"2026-08-27","topic":"AI agents","similarity":0.305,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-27/07-wikiskill-compiling-agent-experience-into-persistent-knowledge-for-ski.md"},{"title":"LamsonRetail/lsr-agent-platform","date":"2026-08-18","topic":"AI dev tools","similarity":0.288,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-08-18/13-lamsonretail-lsr-agent-platform.md"},{"title":"Show HN: Keen Code – an agentic-engineered coding agent","date":"2026-08-10","topic":"AI agents","similarity":0.244,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-10/06-show-hn-keen-code-an-agentic-engineered-coding-agent.md"}]
pros: ["Recently updated (2026-09-07)","Apache-2.0 license","48 GitHub stars","GitHub Actions/CI detected"]
cons: ["Integration may take more than a quick install","README mentions credentials or API tokens"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 5
dependency_files: [{"name":"package.json","summary":"deps @anthropic-ai/sdk, boxen, chalk, commander, inquirer, mellea-skills-cli, ora; scripts interactive"},{"name":"pyproject.toml","summary":"python project; deps requires, build-backend, name, description, dynamic, readme, requires-python, license"}]
install_commands: ["git clone https://github.com/generative-computing/mellea-skills-compiler","pip install -e .","pip install vllm","ollama pull granite4.1:3b","ollama pull ibm/granite3.3-guardian:8b"]
...
Agent specification certification pipeline — from skill specs to governed, certified Mellea pipelines
...
Dependency files:
- package.json: deps @anthropic-ai/sdk, boxen, chalk, commander, inquirer, mellea-skills-cli, ora; scripts interactive
- pyproject.toml: python project; deps requires, build-backend, name, description, dynamic, readme, requires-python, license
