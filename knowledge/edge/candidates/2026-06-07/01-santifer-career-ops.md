...
composite: 82
replacement_target: ""
related_articles: [{"title":"Show HN: Agent-estimate, how long a coding task takes, at agent speed","date":"2026-05-21","topic":"AI agents","similarity":0.235,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-05-21/40-show-hn-agent-estimate-how-long-a-coding-task-takes-at-agent-speed.md"},{"title":"Show HN: I Made a Claude Skill for Spec-Driven Development (SDD)","date":"2026-05-21","topic":"AI dev tools","similarity":0.232,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-05-21/43-show-hn-i-made-a-claude-skill-for-spec-driven-development-sdd.md"},{"title":"Show HN: Cost.dev (YC W21) – making agents cost-aware and cheaper to call","date":"2026-06-04","topic":"AI agents","similarity":0.219,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-06-04/09-show-hn-cost-dev-yc-w21-making-agents-cost-aware-and-cheaper-to-call.md"}]
pros: ["Recently updated (2026-06-07)","MIT license","49591 GitHub stars","GitHub Actions/CI detected"]
cons: ["README mentions credentials or API tokens","README mentions telemetry/analytics"]
readme_quality: 100
has_ci: true
has_tests: false
setup_steps_count: 4
dependency_files: [{"name":"package.json","summary":"deps @google/generative-ai, dotenv, js-yaml, playwright; scripts doctor, verify, normalize, dedup, merge, pdf, sync-check, update:check"}]
install_commands: ["git clone https://github.com/santifer/career-ops.git","npx playwright install chromium   # Required for PDF generation","npm run doctor                     # Validates all prerequisites","claude   # Open Claude Code in this directory","npm install -g @google/gemini-cli","npm install"]
...
Dependency files:
- package.json: deps @google/generative-ai, dotenv, js-yaml, playwright; scripts doctor, verify, normalize, dedup, merge, pdf, sync-check, update:check
