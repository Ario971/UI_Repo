...
url: "https://github.com/FROWNINGdev/django-orm-lens"
date: "2026-07-14"
...
composite: 70
replacement_target: ""
related_articles: [{"title":"Show HN: AnswerJournal – An MCP server to save and share AI answers","date":"2026-06-23","topic":"AI dev tools","similarity":0.274,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-06-23/11-show-hn-answerjournal-an-mcp-server-to-save-and-share-ai-answers.md"},{"title":"Show HN: Ctx, save tokens by loading only the relevant tools","date":"2026-06-16","topic":"AI agents","similarity":0.216,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-06-16/52-show-hn-ctx-save-tokens-by-loading-only-the-relevant-tools.md"},{"title":"sairajbaman/loopspec","date":"2026-06-21","topic":"AI dev tools","similarity":0.21,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-06-21/06-sairajbaman-loopspec.md"}]
pros: ["Recently updated (2026-07-14)","MIT license","2 GitHub stars","GitHub Actions/CI detected"]
cons: ["Integration may take more than a quick install","README mentions telemetry/analytics"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 3
dependency_files: [{"name":"package.json","summary":"deps @types/node, @types/vscode, @vscode/vsce, sharp, typescript; scripts vscode:prepublish, build, test, watch, package, publish"}]
install_commands: ["pip install django-orm-lens","pip install \"django-orm-lens[mcp]\"","pip install django-orm-lens              # CLI only","pip install \"django-orm-lens[mcp]\"       # + MCP server for AI agents","pip install django-orm-lens && django-orm-lens scan"]
...
Dependency files:
- package.json: deps @types/node, @types/vscode, @vscode/vsce, sharp, typescript; scripts vscode:prepublish, build, test, watch, package, publish
...
- pip install django-orm-lens && django-orm-lens scan
