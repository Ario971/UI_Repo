---
id: "toshtag/code-pact"
name: "toshtag/code-pact"
...
composite: 74
replacement_target: ""
related_articles: [{"title":"Kuberwastaken/VPSmaxxing","date":"2026-06-30","topic":"AI dev tools","similarity":0.36,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-06-30/13-kuberwastaken-vpsmaxxing.md"},{"title":"LuD1161/agentjail","date":"2026-06-23","topic":"AI dev tools","similarity":0.337,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-06-23/12-lud1161-agentjail.md"},{"title":"Show HN: Policy enforcement for Claude Code, Cursor, and Codex","date":"2026-07-09","topic":"AI dev tools","similarity":0.325,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-07-09/10-show-hn-policy-enforcement-for-claude-code-cursor-and-codex.md"}]
pros: ["Recently updated (2026-07-14)","MIT license","1 GitHub stars","GitHub Actions/CI detected"]
cons: ["README mentions telemetry/analytics"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 4
dependency_files: [{"name":"package.json","summary":"deps yaml, zod, @types/node, esbuild, github-slugger, tsup, tsx, typescript; scripts build, test, test:unit, test:integration:smoke, test:integration:full, test:integration, verify:base, verify:smoke"}]
install_commands: ["npx code-pact tutorial","npx code-pact init --non-interactive --agent claude-code --locale en-US --sample-phase","npx code-pact --version","npm install -g code-pact","pnpm install","pnpm typecheck"]
...
Dependency files:
- package.json: deps yaml, zod, @types/node, esbuild, github-slugger, tsup, tsx, typescript; scripts build, test, test:unit, test:integration:smoke, test:integration:full, test:integration, verify:base, verify:smoke
