---
id: "dankosik/super-review"
name: "Dankosik/super-review"
url: "https://github.com/Dankosik/super-review"
date: "2026-09-17"
...
composite: 72
replacement_target: ""
related_articles: [{"title":"WikiSkill: Compiling Agent Experience into Persistent Knowledge for Skill Evolution","date":"2026-08-27","topic":"AI agents","similarity":0.246,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-27/07-wikiskill-compiling-agent-experience-into-persistent-knowledge-for-ski.md"}]
...
has_tests: true
setup_steps_count: 3
dependency_files: [{"name":"package.json","summary":"deps @types/bun, typescript; scripts test, typecheck, validate, package, build"}]
install_commands: ["codex plugin marketplace add Dankosik/agent-skills-marketplace","codex plugin add super-review@dankosik-skills","claude plugin marketplace add Dankosik/agent-skills-marketplace","claude plugin install super-review@dankosik-skills"]
risk_flags: []
status: "new"
---

# Dankosik/super-review

Independent readability and maintainability review for Go pull requests. A portable skill with a native OpenCode adapter.
...
Dependency files:
- package.json: deps @types/bun, typescript; scripts test, typecheck, validate, package, build
