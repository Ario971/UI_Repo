...
composite: 74
replacement_target: ""
related_articles: [{"title":"Show HN: AgentNest, self-hosted sandboxes for AI agents","date":"2026-07-23","topic":"AI agents","similarity":0.303,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-07-23/06-show-hn-agentnest-self-hosted-sandboxes-for-ai-agents.md"},{"title":"MARC v1: An Open-Source Multi-Agent Framework for Clinical AI Reasoning and Coordination","date":"2026-08-13","topic":"AI agents","similarity":0.283,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-13/08-marc-v1-an-open-source-multi-agent-framework-for-clinical-ai-reasoning.md"},{"title":"Show HN: Artifex - Graph Based GPU Harness for AI Agents","date":"2026-08-14","topic":"AI agents","similarity":0.279,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-14/09-show-hn-artifex-graph-based-gpu-harness-for-ai-agents.md"}]
pros: ["Recently updated (2026-08-23)","MIT license","33 GitHub stars","GitHub Actions/CI detected"]
cons: ["Integration may take more than a quick install","README includes remote script execution pattern"]
readme_quality: 85
has_ci: true
has_tests: true
setup_steps_count: 5
dependency_files: [{"name":"package.json","summary":"package metadata could not be parsed"}]
install_commands: ["npm install -g @xopcai/xopc","npm install -g @huggingface/transformers@3.8.1 sherpa-onnx-node@1.13.4","npm install -g @composio/core@0.14.0 @composio/experimental@0.2.0","npm install -g @larksuiteoapi/node-sdk@1.66.0 playwright-core@1.60.0","git clone https://github.com/xopcai/xopc.git && cd xopc","pnpm exec xopc onboard"]
...
Open-source, self-hosted personal AI runtime for durable goals, agent workflows, and automations—local-first, BYOK, and available on desktop, web, CLI, and chat.

URL: https://github.com/xopcai/xopc

## Why it matters
You saved an article on 2026-07-23 about AI agents; this candidate overlaps with "Show HN: AgentNest, self-hosted sandboxes for AI agents" and may turn that reading into a practical workflow improvement.
