---
id: "dictation354/paper-fetch-skill"
name: "Dictation354/paper-fetch-skill"
...
composite: 81
replacement_target: ""
related_articles: [{"title":"jhwreal/wechat-article-pipeline-skill","date":"2026-05-28","topic":"AI agents","similarity":0.257,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-05-28/13-jhwreal-wechat-article-pipeline-skill.md"},{"title":"Show HN: Cost.dev (YC W21) – making agents cost-aware and cheaper to call","date":"2026-06-04","topic":"AI agents","similarity":0.233,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-06-04/09-show-hn-cost-dev-yc-w21-making-agents-cost-aware-and-cheaper-to-call.md"},{"title":"anzy-renlab-ai/pronounce","date":"2026-05-24","topic":"AI dev tools","similarity":0.204,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-05-24/66-anzy-renlab-ai-pronounce.md"}]
pros: ["Recently updated (2026-06-12)","MIT license","159 GitHub stars","GitHub Actions/CI detected"]
cons: ["README mentions credentials or API tokens"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 3
dependency_files: [{"name":"package.json","summary":"deps katex, mathml-to-latex; scripts none"},{"name":"pyproject.toml","summary":"python project; deps requires, build-backend, name, version, description, readme, requires-python, dependencies"},{"name":"requirements.txt","summary":"deps -e .[dev], cloakbrowser>=0.3.28,<0.4"}]
install_commands: ["codex mcp add paper-fetch -- python3 -X utf8 -m paper_fetch.mcp.server"]
risk_flags: ["README mentions credentials or API tokens"]
status: "new"
---

# Dictation354/paper-fetch-skill
...
Dependency files:
- package.json: deps katex, mathml-to-latex; scripts none
- pyproject.toml: python project; deps requires, build-backend, name, version, description, readme, requires-python, dependencies
- requirements.txt: deps -e .[dev], cloakbrowser>=0.3.28,<0.4
