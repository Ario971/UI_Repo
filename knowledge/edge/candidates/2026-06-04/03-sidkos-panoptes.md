---
id: "sidkos/panoptes"
name: "sidkos/panoptes"
url: "https://github.com/sidkos/panoptes"
date: "2026-06-04"
...
composite: 71
replacement_target: ""
related_articles: [{"title":"gHashTag/trios-mcp-rag","date":"2026-05-23","topic":"AI agents","similarity":0.216,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-05-23/53-ghashtag-trios-mcp-rag.md"},{"title":"anuj-devops-sre/Devops-Study","date":"2026-05-29","topic":"AI dev tools","similarity":0.183,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-05-29/30-anuj-devops-sre-devops-study.md"}]
pros: ["Recently updated (2026-06-04)","Apache-2.0 license","1 GitHub stars","GitHub Actions/CI detected"]
cons: ["Integration may take more than a quick install","README mentions credentials or API tokens"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 4
dependency_files: [{"name":"pyproject.toml","summary":"python project; deps requires, build-backend, name, version, description, requires-python, license, dependencies"}]
install_commands: ["docker compose up --build     # Grafana on :3000, VictoriaMetrics on :8428","pip install -e '.[dev]'","docker compose"]
...
Dependency files:
- pyproject.toml: python project; deps requires, build-backend, name, version, description, requires-python, license, dependencies
