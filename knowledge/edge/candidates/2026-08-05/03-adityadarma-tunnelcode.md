---
id: "adityadarma/tunnelcode"
name: "adityadarma/tunnelcode"
url: "https://github.com/adityadarma/tunnelcode"
date: "2026-08-05"
...
composite: 70
replacement_target: ""
related_articles: [{"title":"Show HN: Rules that stop AI coding agents from breaking working code","date":"2026-07-26","topic":"AI agents","similarity":0.32,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-07-26/07-show-hn-rules-that-stop-ai-coding-agents-from-breaking-working-code.md"},{"title":"Show HN: Abralo – Free, easy way to run several Claude Code agents in one window","date":"2026-07-08","topic":"AI agents","similarity":0.309,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-07-08/07-show-hn-abralo-free-easy-way-to-run-several-claude-code-agents-in-one-.md"},{"title":"Show HN: Forall – An AI coding agent that generates machine-checkable proofs","date":"2026-07-16","topic":"AI agents","similarity":0.291,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-07-16/06-show-hn-forall-an-ai-coding-agent-that-generates-machine-checkable-pro.md"}]
pros: ["Recently updated (2026-08-05)","MIT license","GitHub Actions/CI detected","README mentions tests or validation"]
cons: ["Integration may take more than a quick install","README mentions credentials or API tokens"]
readme_quality: 100
has_ci: true
has_tests: true
setup_steps_count: 6
dependency_files: [{"name":"package.json","summary":"deps tunnelcode, @eslint/js, @types/node, eslint, eslint-config-prettier, prettier, typescript, typescript-eslint; scripts build, clean, typecheck, lint, lint:fix, format, format:check, test"}]
install_commands: ["npm i -g tunnelcode","pnpm install","pnpm build","pnpm --filter tunnelcode-server start","pnpm exec tunnelcode","docker build -t tunnelcode ."]
risk_flags: ["README mentions credentials or API tokens"]
status: "new"
---

# adityadarma/tunnelcode

Run an AI coding agent on your own machine and drive it from a browser. Pair your phone with a QR code, watch replies stream in, and approve every shell command or file write from wherever you are. Works with OpenCode, Claude Code, Antigravity CLI and Kiro CLI.

URL: https://github.com/adityadarma/tunnelcode

## Why it matters
You saved an article on 2026-07-26 about AI agents; this candidate overlaps with "Show HN: Rules that stop AI coding agents from breaking working code" and may turn that reading into a practical workflow improvement.
...
Dependency files:
- package.json: deps tunnelcode, @eslint/js, @types/node, eslint, eslint-config-prettier, prettier, typescript, typescript-eslint; scripts build, clean, typecheck, lint, lint:fix, format, format:check, test
