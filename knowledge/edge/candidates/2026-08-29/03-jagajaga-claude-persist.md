---
id: "jagajaga/claude-persist"
name: "jagajaga/claude-persist"
url: "https://github.com/jagajaga/claude-persist"
date: "2026-08-29"
...
composite: 73
replacement_target: ""
related_articles: [{"title":"Show HN: Claude-account – switch Claude Code accounts without logging in again","date":"2026-07-30","topic":"AI dev tools","similarity":0.49,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-07-30/12-show-hn-claude-account-switch-claude-code-accounts-without-logging-in-.md"},{"title":"scian0204/ClaudeCodeWorkspace","date":"2026-08-04","topic":"AI dev tools","similarity":0.4,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-08-04/11-scian0204-claudecodeworkspace.md"},{"title":"From Code Review to Code Critique: Intent, Drift, and Spotlight for AI-Generated Diffs at Scale","date":"2026-07-31","topic":"AI agents","similarity":0.293,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-07-31/06-from-code-review-to-code-critique-intent-drift-and-spotlight-for-ai-ge.md"}]
pros: ["Recently updated (2026-08-29)","MIT license","2 GitHub stars","GitHub Actions/CI detected"]
cons: ["README mentions telemetry/analytics"]
readme_quality: 85
has_ci: true
has_tests: true
setup_steps_count: 2
dependency_files: [{"name":"package.json","summary":"deps @anthropic-ai/claude-agent-sdk, @types/node, dompurify, jsdom, marked, sharp, typescript; scripts build, test, daemon"}]
install_commands: ["npm install","npm run build          # tsc for shared, daemon and extension","npm test               # 209 daemon + 185 extension tests"]
risk_flags: ["README mentions telemetry/analytics"]
status: "new"
---

# jagajaga/claude-persist
...
Dependency files:
- package.json: deps @anthropic-ai/claude-agent-sdk, @types/node, dompurify, jsdom, marked, sharp, typescript; scripts build, test, daemon
