...
composite: 75
replacement_target: ""
related_articles: [{"title":"Show HN: Itsuki – open-source memory engine for AI agents (API and MCP)","date":"2026-08-29","topic":"AI agents","similarity":0.373,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-29/06-show-hn-itsuki-open-source-memory-engine-for-ai-agents-api-and-mcp.md"},{"title":"qgeng1465/bio-mcp","date":"2026-08-11","topic":"AI dev tools","similarity":0.352,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-08-11/13-qgeng1465-bio-mcp.md"},{"title":"blurifycom/openora","date":"2026-07-29","topic":"AI dev tools","similarity":0.298,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-07-29/12-blurifycom-openora.md"}]
pros: ["Recently updated (2026-08-29)","MIT license","9190 GitHub stars","GitHub Actions/CI detected"]
cons: ["Integration may take more than a quick install","README mentions credentials or API tokens"]
readme_quality: 85
has_ci: true
has_tests: false
setup_steps_count: 4
dependency_files: [{"name":"package.json","summary":"deps @dotenvx/dotenvx, @infisical/cli, @tanstack/eslint-plugin-query, dprint, eslint, lint-staged, oxfmt, oxlint; scripts dev:desktop, dev:web, fmt:check, fmt, lint, lint:eslint, lint:oxlint, plugin:hello-world:install"},{"name":"Cargo.toml","summary":"Rust project metadata detected"},{"name":"go.mod","summary":"module anarlog"}]
install_commands: ["pnpm install --frozen-lockfile","pnpm exec turbo dev:desktop","pnpm exec turbo dev:web"]
...
Dependency files:
- package.json: deps @dotenvx/dotenvx, @infisical/cli, @tanstack/eslint-plugin-query, dprint, eslint, lint-staged, oxfmt, oxlint; scripts dev:desktop, dev:web, fmt:check, fmt, lint, lint:eslint, lint:oxlint, plugin:hello-world:install
- Cargo.toml: Rust project metadata detected
- go.mod: module anarlog
