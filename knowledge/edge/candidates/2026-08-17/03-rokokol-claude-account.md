---
id: "rokokol/claude-account"
name: "rokokol/claude-account"
url: "https://github.com/rokokol/claude-account"
date: "2026-08-17"
source: "awesome-mcp"
...
composite: 68
replacement_target: ""
related_articles: [{"title":"Show HN: Claude-account – switch Claude Code accounts without logging in again","date":"2026-07-30","topic":"AI dev tools","similarity":0.569,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-07-30/12-show-hn-claude-account-switch-claude-code-accounts-without-logging-in-.md"},{"title":"Show HN: Throttle – Local Claude Cockpit for macOS, now with remote control","date":"2026-07-16","topic":"AI dev tools","similarity":0.312,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-07-16/11-show-hn-throttle-local-claude-cockpit-for-macos-now-with-remote-contro.md"},{"title":"scian0204/ClaudeCodeWorkspace","date":"2026-08-04","topic":"AI dev tools","similarity":0.277,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-08-04/11-scian0204-claudecodeworkspace.md"}]
pros: ["Recently updated (2026-08-17)","MIT license","GitHub Actions/CI detected","README mentions tests or validation"]
...
setup_steps_count: 4
dependency_files: []
install_commands: ["claude-account use work    # and the next `claude` is the work account","claude-account list             # profiles with their email, the active one starred","claude-account use <name>       # make one active","claude-account add <name>       # create one, then `claude` → /login","claude-account current          # name of the active profile","claude-account path             # its directory"]
risk_flags: ["README mentions credentials or API tokens","May require elevated privileges"]
status: "new"
---

# rokokol/claude-account

Manage Claude Code accounts that share one memory and one set of skills
