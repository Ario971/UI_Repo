...
composite: 75
replacement_target: ""
related_articles: [{"title":"Show HN: Keen Code – an agentic-engineered coding agent","date":"2026-08-10","topic":"AI agents","similarity":0.282,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-10/06-show-hn-keen-code-an-agentic-engineered-coding-agent.md"},{"title":"Show HN: Taurus Agents, my take on multi-agent hierarchies","date":"2026-08-13","topic":"AI agents","similarity":0.264,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-13/07-show-hn-taurus-agents-my-take-on-multi-agent-hierarchies.md"},{"title":"Show HN: Parley – your coding agent can talk to a teammate's agent","date":"2026-08-11","topic":"AI agents","similarity":0.26,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-08-11/06-show-hn-parley-your-coding-agent-can-talk-to-a-teammate-s-agent.md"}]
pros: ["Recently updated (2026-08-17)","MIT license","27 GitHub stars","GitHub Actions/CI detected"]
...
setup_steps_count: 3
dependency_files: []
install_commands: ["git clone https://github.com/byte5ai/omadia.git && cd omadia","docker compose up -d","docker compose -f docker-compose.yaml -f docker-compose.build.yaml up -d --build  # build locally","docker compose -f docker-compose.yaml -f docker-compose.storage.yaml up -d","docker compose -f docker-compose.yaml \\","docker compose -f docker-compose.yaml -f docker-compose.embeddings.yaml up -d"]
