---
id: "kkenny0/card-skill"
name: "KKenny0/card-skill"
...
composite: 73
replacement_target: ""
related_articles: [{"title":"Kuberwastaken/VPSmaxxing","date":"2026-06-30","topic":"AI dev tools","similarity":0.395,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-06-30/13-kuberwastaken-vpsmaxxing.md"},{"title":"UPDATE: I built a tool to turn your Claude Code sessions into fine-tuning data for local models (You can now convert your Codex and Pi sessions)","date":"2026-07-07","topic":"Local LLMs","similarity":0.286,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/Local LLMs/2026-07-07/16-update-i-built-a-tool-to-turn-your-claude-code-sessions-into-fine-tuni.md"},{"title":"Show HN: Abralo – Free, easy way to run several Claude Code agents in one window","date":"2026-07-08","topic":"AI agents","similarity":0.28,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-07-08/07-show-hn-abralo-free-easy-way-to-run-several-claude-code-agents-in-one-.md"}]
pros: ["Recently updated (2026-07-26)","MIT license","5 GitHub stars","GitHub Actions/CI detected"]
cons: ["README mentions credentials or API tokens"]
readme_quality: 85
has_ci: true
has_tests: false
setup_steps_count: 3
dependency_files: [{"name":"package.json","summary":"deps playwright; scripts check-output, package-skill, test, validate, smoke, eval:fresh, gallery:check, gallery:update"}]
install_commands: ["codex plugin marketplace add KKenny0/card-skill","codex plugin add card-skill@card-skill","npx skills add KKenny0/card-skill/plugins/card-skill/skills/card-skill -a codex -g -y","npm install","npx playwright install chromium","npx skills use KKenny0/card-skill/plugins/card-skill/skills/card-skill --skill card-skill"]
...
Content in, PNG out. A Claude Code/Codex skill that turns articles, ideas, and arguments into checked Quiet Paper PNGs: cards, posters, whiteboards, and editorial images.
...
Dependency files:
- package.json: deps playwright; scripts check-output, package-skill, test, validate, smoke, eval:fresh, gallery:check, gallery:update
