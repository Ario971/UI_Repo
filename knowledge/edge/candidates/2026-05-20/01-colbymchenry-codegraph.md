...
replacement_target: ""
related_articles: []
pros: ["Recently updated (2026-05-20)","MIT license","9267 GitHub stars","README mentions tests or validation"]
cons: ["Integration may take more than a quick install","May require elevated privileges"]
readme_quality: 100
has_ci: false
has_tests: true
setup_steps_count: 4
dependency_files: [{"name":"package.json","summary":"deps @clack/prompts, commander, fast-string-width, fast-wrap-ansi, jsonc-parser, node-sqlite3-wasm, picomatch, sisteransi; scripts build, preuninstall, copy-assets, dev, cli, test, test:watch, test:eval"}]
install_commands: ["npx @colbymchenry/codegraph","npm install -g @colbymchenry/codegraph","git diff --name-only | codegraph affected --stdin   # Pipe from git diff","npx vitest run $AFFECTED","npm rebuild better-sqlite3","npm install better-sqlite3 --save"]
risk_flags: ["May require elevated privileges"]
status: "new"
---
...
## Why it matters
colbymchenry/codegraph matches your AI development source filters and scored strongly enough to review before it disappears into the daily noise.
...
Dependency files:
- package.json: deps @clack/prompts, commander, fast-string-width, fast-wrap-ansi, jsonc-parser, node-sqlite3-wasm, picomatch, sisteransi; scripts build, preuninstall, copy-assets, dev, cli, test, test:watch, test:eval
