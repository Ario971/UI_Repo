---
id: "prime-radiant-inc/superpowers-evals"
name: "prime-radiant-inc/superpowers-evals"
...
momentum: 79
risk: 50
integration_effort: 29
expected_gain: 87
composite: 76
replacement_target: ""
related_articles: [{"title":"Show HN: Policy enforcement for Claude Code, Cursor, and Codex","date":"2026-07-09","topic":"AI dev tools","similarity":0.287,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI dev tools/2026-07-09/10-show-hn-policy-enforcement-for-claude-code-cursor-and-codex.md"},{"title":"Show HN: ctx – Search the coding agent history already on your machine","date":"2026-07-02","topic":"AI agents","similarity":0.281,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-07-02/07-show-hn-ctx-search-the-coding-agent-history-already-on-your-machine.md"},{"title":"Show HN: AMA2, messenger built for AI agent","date":"2026-06-30","topic":"AI agents","similarity":0.279,"file":"/home/runner/work/UI_Repo/UI_Repo/knowledge/feed/AI agents/2026-06-30/06-show-hn-ama2-messenger-built-for-ai-agent.md"}]
pros: ["Recently updated (2026-07-17)","74 GitHub stars","GitHub Actions/CI detected","README mentions tests or validation"]
cons: ["License was not clearly detected by GitHub","README mentions credentials or API tokens"]
readme_quality: 92
has_ci: true
has_tests: true
setup_steps_count: 1
dependency_files: [{"name":"package.json","summary":"deps @primeradianthq/obol, commander, yaml, zod, @biomejs/biome, @types/bun, typescript; scripts quorum, appliance, dashboard, test, typecheck, lint, lint:fix, format"}]
install_commands: ["claude setup-token"]
...
## Why it matters
You saved an article on 2026-07-09 about AI dev tools; this candidate overlaps with "Show HN: Policy enforcement for Claude Code, Cursor, and Codex" and may turn that reading into a practical workflow improvement.

## Pros
+ Recently updated (2026-07-17)
+ 74 GitHub stars
...
Dependency files:
- package.json: deps @primeradianthq/obol, commander, yaml, zod, @biomejs/biome, @types/bun, typescript; scripts quorum, appliance, dashboard, test, typecheck, lint, lint:fix, format
